...
{        
    ...
    {
        public AsmInstructionInfo(ushort Offset, string Display, string Mnemonic, string OpCode, AsmOperand[] Operands, string EncodingKind, byte[] Encoding)
        {
            this.Offset = Offset;
        ...
        /// </summary>
        public AsmOperand[] Operands {get;}
