...
namespace Z0
{
    ...
    partial class AsmOps
    {
        ...
        static ReadOnlySpan<byte> SqrtF32Bytes 
            => new byte[10]{0xC5,0xF8,0x77,0x66,0x90,0xC5,0xFA,0x51,0xC0,0xC3};      

        static ReadOnlySpan<byte> SqrtF64Bytes 
            => new byte[10]{0xC5,0xF8,0x77,0x66,0x90,0xC5,0xFB,0x51,0xC0,0xC3};  
