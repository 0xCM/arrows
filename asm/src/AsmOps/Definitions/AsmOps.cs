...
namespace Z0.Asm
{
    ...
    {
        readonly struct DivRemOp
        {
            static readonly AsmQuadOp<int> Op = AsmQuadOp.Create<int>(AsmCodeBank.DivRemI32);
            
            public static readonly DivRemOp TheOnly = default;

            [MethodImpl(Inline)]
            public void Invoke(int lhs, int rhs, out int q, out int r)
        ...
        public static void DivRem(int x, int y, out int q, out int r)
            => DivRemOp.TheOnly.Invoke(x, y, out q, out r);
