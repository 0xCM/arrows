...
namespace Z0.Asm
{
    ...
    public abstract class RegisterExpr<N,T> : AsmExpr
        where N : ITypeNat, new()
        where T : Enum
    {
        protected RegisterExpr(T RegId)
        {
            this.RegId = RegId;
    ...
    /// </summary>
    public abstract class Reg8Expr : RegisterExpr<N8,GpRegId8>
    {
    ...
    /// </summary>
    public abstract class Reg16Expr : RegisterExpr<N16,GpRegId16>
    {
    ...
    /// </summary>
    public abstract class Reg32Expr : RegisterExpr<N32,GpRegId32>
    {
    ...
    /// </summary>
    public abstract class Reg64Expr : RegisterExpr<N64,GpRegId64>
    {
