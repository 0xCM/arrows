...
namespace Z0
{
    ...
    public readonly struct NumberInfo : 
        INumInfoProvider<byte>, 
        INumInfoProvider<sbyte>, 
        INumInfoProvider<short>,
        INumInfoProvider<ushort>, 
        INumInfoProvider<int>,
        INumInfoProvider<uint>,
        INumInfoProvider<long>,
        INumInfoProvider<ulong>,            
        INumInfoProvider<float>, 
        INumInfoProvider<double>, 
        INumInfoProvider<decimal>,
        INumInfoProvider<BigInteger>                    
    {
        static readonly NumberInfo Inhabitant = default;

        [MethodImpl(Inline)]
        public static NumberInfo<T> Get<T>()
            => Provider<T>().numinfo;            

        [MethodImpl(Inline)]
        public static INumInfoProvider<T> Provider<T>() 
            => cast<INumInfoProvider<T>>(Inhabitant);

        NumberInfo<sbyte> INumInfoProvider<sbyte>.numinfo 
            => Int8Info.Summary;

        NumberInfo<byte> INumInfoProvider<byte>.numinfo 
            => UInt8Info.Summary;

        NumberInfo<short> INumInfoProvider<short>.numinfo 
            => Int16Info.Summary;

        NumberInfo<ushort> INumInfoProvider<ushort>.numinfo 
            => UInt16Info.Summary;

        NumberInfo<int> INumInfoProvider<int>.numinfo 
            => Int32Info.Summary;

        NumberInfo<uint> INumInfoProvider<uint>.numinfo 
            => UInt32Info.Summary;

        NumberInfo<long> INumInfoProvider<long>.numinfo 
            => Int64Info.Summary;

        NumberInfo<ulong> INumInfoProvider<ulong>.numinfo 
            => UInt64Info.Summary;

        NumberInfo<float> INumInfoProvider<float>.numinfo 
            => Float32Info.Summary;

        NumberInfo<double> INumInfoProvider<double>.numinfo 
            => Float64Info.Summary;

        NumberInfo<decimal> INumInfoProvider<decimal>.numinfo 
            => DecimalInfo.Summary;

        NumberInfo<BigInteger> INumInfoProvider<BigInteger>.numinfo 
