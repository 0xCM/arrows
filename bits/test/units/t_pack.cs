...
namespace Z0.Test
{
    ...
    public class t_pack : UnitTest<t_pack>
    {
        ...
        {            
            ...
            var z0 = y.ReadValues<uint>(out Span<byte> rem);
            Claim.eq(1, z0.Length);

            var z1 = z0[0];
            var z2 = rem.TakePartial<uint>();

            var bsOutput = BitString.FromScalars(z1,z2).Truncate(bitcount);
