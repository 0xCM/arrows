...
namespace Z0
{
    ...
    {                
        ...
        [MethodImpl(Inline)]
        public static Vec256<ulong> rotl(Vec256<ulong> src, Vec256<ulong> offsets)
        {
        ...
        /// <param name="offsets">The offset vector</param>
        [MethodImpl(Inline)]
        public static Vec256<uint> rotl(Vec256<uint> src, Vec256<uint> offsets)
        {
            var x = Bits.sllv(src,offsets);
        ...
        /// <param name="offsets">The offset vector</param>
        [MethodImpl(Inline)]
        public static Vec128<ulong> rotl(Vec128<ulong> src, Vec128<ulong> offsets)
        {
            var x = Bits.sllv(src,offsets);
        ...
        /// <param name="offsets">The offset vector</param>
        [MethodImpl(Inline)]
        public static Vec128<uint> rotl(Vec128<uint> src, Vec128<uint> offsets)
        {
            var x = Bits.sllv(src,offsets);
