...
namespace Z0
{
    ...
    {                
        ...
        /// <param name="offset">The magnitude of the rotation</param>
        [MethodImpl(Inline)]
        public static Vec128<uint> rotr(Vec128<uint> src, Vec128<uint> offsets)
        {
        ...
        /// <param name="offset">The magnitude of the rotation</param>
        [MethodImpl(Inline)]
        public static Vec128<ulong> rotr(Vec128<ulong> src, Vec128<ulong> offsets)
        {
            var x = Bits.srlv(in src, offsets);
        ...
        /// <param name="offset">The magnitude of the rotation</param>
        [MethodImpl(Inline)]
        public static Vec256<uint> rotr(Vec256<uint> src, Vec256<uint> offsets)
        {
            var x = Bits.srlv(in src, offsets);
        ...
        /// <param name="offset">The magnitude of the rotation</param>
        [MethodImpl(Inline)]
        public static Vec256<ulong> rotr(Vec256<ulong> src, Vec256<ulong> offsets)
        {
            var x = Bits.srlv(in src, offsets);
