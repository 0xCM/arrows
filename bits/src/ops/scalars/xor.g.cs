...
namespace Z0
{
    ...
    partial class gbits
    {
        ...
        [MethodImpl(Inline)]
        public static MemorySpan<T> xor<T>(ReadOnlyMemory<T> lhs, ReadOnlyMemory<T> rhs, MemorySpan<T> dst)
            where T : unmanaged
        {
        ...
        [MethodImpl(Inline)]
        public static MemorySpan<T> xor<T>(MemorySpan<T> lhs, MemorySpan<T> rhs)
            where T : unmanaged
        {
