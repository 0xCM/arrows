...
namespace Z0
{
    ...
    partial class Bits
    {
        ...
        /// <summary>
        /// Projects an identified partition from a source value into the 
        /// low bits an empty 32-bit target returns the target value after 
        /// converting it to a specified primal type
        /// </summary>
        /// <param name="src">The bit source</param>
        /// <param name="part">The selected partition</param>
