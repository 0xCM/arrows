...
namespace Z0
{
    ...
    {                        
        ...
        [MethodImpl(Inline)]
        public static sbyte range(sbyte src, BitIndex i0, BitIndex i1)
        ...
        /// <intrinsic>unsigned int _bextr_u32 (unsigned int a, unsigned int start, unsigned int len) BEXTR r32a, reg/m32, r32b</intrinsic>
        [MethodImpl(Inline)]
        public static byte range(byte src, BitIndex i0, BitIndex i1)
            => (byte)Bmi1.BitFieldExtract(src, i0, (byte)(i1 - i0 + 1));            
        ...
        /// <intrinsic>unsigned int _bextr_u32 (unsigned int a, unsigned int start, unsigned int len) BEXTR r32a, reg/m32, r32b</intrinsic>
        [MethodImpl(Inline)]
        public static ushort range(ushort src, BitIndex i0, BitIndex i1)
            => (ushort)Bmi1.BitFieldExtract(src, (byte)i0, (byte)(i1 - i0 + 1));            
        ...
        /// <intrinsic>unsigned int _bextr_u32 (unsigned int a, unsigned int start, unsigned int len) BEXTR r32a, reg/m32, r32b</intrinsic>
        [MethodImpl(Inline)]
        public static short range(short src, BitIndex i0, BitIndex i1)
        ...
        [MethodImpl(Inline)]
        public static uint range(uint src, BitIndex i0, BitIndex i1)
        ...
        /// <intrinsic>unsigned int _bextr_u32 (unsigned int a, unsigned int start, unsigned int len) BEXTR r32a, reg/m32, r32b</intrinsic>
        [MethodImpl(Inline)]
        public static int range(int src, BitIndex i0, BitIndex i1)
        ...
        /// <intrinsic>unsigned __int64 _bextr_u64(unsigned __int64 a, unsigned int start, unsigned int len) BEXTR r64a, reg/m64, r64b </intrinsic>
        [MethodImpl(Inline)]
        public static ulong range(ulong src, BitIndex i0, BitIndex i1)
        ...
        /// <intrinsic>unsigned int _bextr_u32 (unsigned int a, unsigned int start, unsigned int len) BEXTR r32a, reg/m32, r32b</intrinsic>
        [MethodImpl(Inline)]
        public static long range(long src, BitIndex i0, BitIndex i1)
