...
namespace Z0
{
    ...
    partial class Bits
    {
        ...
        [MethodImpl(Inline)]
        public static T project<T>(ushort src, Part10x2 part)
            where T : unmanaged
        ...
        /// <typeparam name="T">The primal conversion type</typeparam>
        [MethodImpl(Inline)]
        public static T project<T>(ushort src, Part12x2 part)
            where T : unmanaged
                => convert<T>(project(src,part));
        ...
        /// <typeparam name="T">The primal conversion type</typeparam>
        [MethodImpl(Inline)]
        public static T project<T>(ushort src, Part32x2 part)
            where T : unmanaged
                => convert<T>(project(src, part));
