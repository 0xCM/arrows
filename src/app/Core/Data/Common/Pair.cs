...
namespace Core
{
    ...
    partial class Reify
    {
        ...
        /// of another type
        /// </summary>
        public readonly struct Pair<A,B> : Core.Pair<A,B>
        {        
            public A left {get;}
        ...
        /// of another type
        /// </summary>
        public readonly struct Copair<A,B> : Core.Copair<A, B>
        {
...
partial class corext
{
    ...
    public static bool IsLeft<A,B>(this Core.Copair<A,B> cp)
        => cp.left.exists;

    public static bool IsRight<A,B>(this Core.Copair<A,B> cp)
        => cp.right.exists;
}
