...
namespace Core
{
    ...
    using opstype = Operations.Int32Ops;
    ...
    partial class Operations
    {
        ...
        internal readonly struct Int32Ops : FiniteSignedInt<opstype,systype>
        {
            ...
            [MethodImpl(Inline)]   
            public Quorem<int> divrem(systype a, systype b)
                => new Quorem<int>(a/b,a%b);
