    ...
    public static class HexDigits
    {
        ...
        public static HexDigit parse(char c)
            => c switch{
                ...
                'E' => XE,
                'F' => XF,
                _ => throw new NotSupportedException($"The character {c} is not recogized as a hexadecimal digit")
            };
        ...
        public static IReadOnlyList<HexDigit> parse(string src)
        {
            var digits = new List<HexDigit>(src.Length);
