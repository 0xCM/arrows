...
namespace Z0
{
    ...
    public partial struct Num128 : IEquatable<Num128>
    {
        ...
        [MethodImpl(Inline)]
        public static Num128 addu8(Num128 lhs, Num128 rhs)
        {
            var dst = default(Num128);
        ...
        [MethodImpl(Inline)]
        public static Num128 addi8(Num128 lhs, Num128 rhs)
        {
            var dst = default(Num128);
        ...
        [MethodImpl(Inline)]
        public static Num128 addi16(Num128 lhs, Num128 rhs)
        {
            var dst = default(Num128);
        ...
        [MethodImpl(Inline)]
        public static Num128 addu16(Num128 lhs, Num128 rhs)
        {
            var dst = default(Num128);
        ...
        [MethodImpl(Inline)]
        public static Num128 define(int x0, int x1, int x2, int x3)
        {
            var dst = default(Num128);
            dst.i32(0,x0);
            dst.i32(1,x1);
        ...
        [MethodImpl(Inline)]
        public static Num128 absi32(Num128 src)
        {
            var dst = default(Num128);
        ...
        [MethodImpl(Inline)]
        public static Num128 negatei32(Num128 src)
        {
            var dst = default(Num128);
            for(var i=0; i< i32_count; i++)
                dst.i32(i, - src.i32(i));
        ...
        [MethodImpl(Inline)]
        public static Num128 flipi32(Num128 src)
        {
            var dst = default(Num128);
            for(var i=0; i< i32_count; i++)
                dst.i32(i, ~ src.i32(i));
        ...
        [MethodImpl(Inline)]
        public static Num128 addi32(Num128 lhs, Num128 rhs)
        {        
            var dst = default(Num128);
            for(var i=0; i< i32_count; i++)
        ...
        [MethodImpl(Inline)]
        public static Num128 subi32(Num128 lhs, Num128 rhs)
        {
            var dst = default(Num128);
            for(var i=0; i< i32_count; i++)
                dst.i32(i, (lhs.i32(i) - rhs.i32(i)));
        ...
        [MethodImpl(Inline)]
        public static Num128 muli32(Num128 lhs, Num128 rhs)
        {
            var dst = default(Num128);
            for(var i=0; i< i32_count; i++)
                dst.i32(i, (lhs.i32(i) * rhs.i32(i)));
        ...
        [MethodImpl(Inline)]
        public static Num128 divi32(Num128 lhs, Num128 rhs)
        {
            var dst = default(Num128);
            for(var i=0; i< i32_count; i++)
                dst.i32(i, (lhs.i32(i) / rhs.i32(i)));
        ...
        [MethodImpl(Inline)]
        public static Num128 modi32(Num128 lhs, Num128 rhs)
        {
            var dst = default(Num128);
            for(var i=0; i< i32_count; i++)
                dst.i32(i, (lhs.i32(i) % rhs.i32(i)));
        ...
        [MethodImpl(Inline)]
        public static Num128 andi32(Num128 lhs, Num128 rhs)
        {
            var dst = default(Num128);
            for(var i=0; i< i32_count; i++)
                dst.i32(i, (lhs.i32(i) & rhs.i32(i)));
        ...
        [MethodImpl(Inline)]
        public static Num128 ori32(Num128 lhs, Num128 rhs)
        {
            var dst = default(Num128);
            for(var i=0; i< i32_count; i++)
                dst.i32(i, (lhs.i32(i) | rhs.i32(i)));
        ...
        [MethodImpl(Inline)]
        public static Num128 xori32(Num128 lhs, Num128 rhs)
        {
            var dst = default(Num128);
            for(var i=0; i< i32_count; i++)
                dst.i32(i, (lhs.i32(i) ^ rhs.i32(i)));
        ...
        [MethodImpl(Inline)]
        public static Num128 addu32(Num128 lhs, Num128 rhs)
        {
            var dst = default(Num128);
        ...
        [MethodImpl(Inline)]
        public static Num128 define(long x0, long x1)
        {
            var dst = default(Num128);
            dst.i64(0,x0);
            dst.i64(1,x1);
        ...
        [MethodImpl(Inline)]
        public static Num128 addi64(Num128 lhs, Num128 rhs)
        {
            var dst = default(Num128);
        ...
        [MethodImpl(Inline)]
        public static Num128 define(ulong x0, ulong x1)
        {
            var dst = default(Num128);
            dst.u64(0,x0);
            dst.u64(1,x1);
        ...
        [MethodImpl(Inline)]
        public static Num128 addu64(Num128 lhs, Num128 rhs)
        {
            var dst = default(Num128);
        ...
        [MethodImpl(Inline)]
        public static Num128 addf32(Num128 lhs, Num128 rhs)
        {
            var dst = default(Num128);
        ...
        [MethodImpl(Inline)]
        public static Num128 addf64(Num128 lhs, Num128 rhs)
        {
            var dst = default(Num128);
        ...
        [MethodImpl(Inline)]
        public Num128 addf128(Num128 lhs, Num128 rhs)
        {
            var dst = default(Num128);
