...
namespace Z0
{
    ...
    public struct Num64 
    {
        ...
        [MethodImpl(Inline)]
        public static Num64 addu8(Num64 lhs, Num64 rhs)
        {
            var dst = default(Num64);
        ...
        [MethodImpl(Inline)]
        public static Num64 addi8(Num64 lhs, Num64 rhs)
        {
            var dst = default(Num64);
        ...
        [MethodImpl(Inline)]
        public static Num64 addi16(Num64 lhs, Num64 rhs)
        {
            var dst = default(Num64);
        ...
        [MethodImpl(Inline)]
        public static Num64 addu16(Num64 lhs, Num64 rhs)
        {
            var dst = default(Num64);
        ...
        [MethodImpl(Inline)]
        public static Num64 define(int x0, int x1)
        {
            var dst = default(Num64);
            dst.i32(0,x0);
            dst.i32(1,x1);
        ...
        [MethodImpl(Inline)]
        public static Num64 absi32(Num64 src)
        {
            var dst = default(Num64);
        ...
        [MethodImpl(Inline)]
        public static Num64 negatei32(Num64 src)
        {
            var dst = default(Num64);
            for(var i=0; i< i32_count; i++)
                dst.i32(i, - src.i32(i));
        ...
        [MethodImpl(Inline)]
        public static Num64 flipi32(Num64 src)
        {
            var dst = default(Num64);
            for(var i=0; i< i32_count; i++)
                dst.i32(i, ~ src.i32(i));
        ...
        [MethodImpl(Inline)]
        public static Num64 addi32(Num64 lhs, Num64 rhs)
        {        
            var dst = default(Num64);
            for(var i=0; i< i32_count; i++)
        ...
        [MethodImpl(Inline)]
        public static Num64 subi32(Num64 lhs, Num64 rhs)
        {
            var dst = default(Num64);
            for(var i=0; i< i32_count; i++)
                dst.i32(i, (lhs.i32(i) - rhs.i32(i)));
        ...
        [MethodImpl(Inline)]
        public static Num64 muli32(Num64 lhs, Num64 rhs)
        {
            var dst = default(Num64);
            for(var i=0; i< i32_count; i++)
                dst.i32(i, (lhs.i32(i) * rhs.i32(i)));
        ...
        [MethodImpl(Inline)]
        public static Num64 divi32(Num64 lhs, Num64 rhs)
        {
            var dst = default(Num64);
            for(var i=0; i< i32_count; i++)
                dst.i32(i, (lhs.i32(i) / rhs.i32(i)));
        ...
        [MethodImpl(Inline)]
        public static Num64 modi32(Num64 lhs, Num64 rhs)
        {
            var dst = default(Num64);
            for(var i=0; i< i32_count; i++)
                dst.i32(i, (lhs.i32(i) % rhs.i32(i)));
        ...
        [MethodImpl(Inline)]
        public static Num64 andi32(Num64 lhs, Num64 rhs)
        {
            var dst = default(Num64);
            for(var i=0; i< i32_count; i++)
                dst.i32(i, (lhs.i32(i) & rhs.i32(i)));
        ...
        [MethodImpl(Inline)]
        public static Num64 ori32(Num64 lhs, Num64 rhs)
        {
            var dst = default(Num64);
            for(var i=0; i< i32_count; i++)
                dst.i32(i, (lhs.i32(i) | rhs.i32(i)));
        ...
        [MethodImpl(Inline)]
        public static Num64 xori32(Num64 lhs, Num64 rhs)
        {
            var dst = default(Num64);
            for(var i=0; i< i32_count; i++)
                dst.i32(i, (lhs.i32(i) ^ rhs.i32(i)));
        ...
        [MethodImpl(Inline)]
        public static Num64 addu32(Num64 lhs, Num64 rhs)
        {
            var dst = default(Num64);
        ...
        [MethodImpl(Inline)]
        public static Num64 define(long x0)
        {
            var dst = default(Num64);
            dst.i64(0,x0);
            return dst;
        ...
        [MethodImpl(Inline)]
        public static Num64 addi64(Num64 lhs, Num64 rhs)
        {
            var dst = default(Num64);
        ...
        [MethodImpl(Inline)]
        public static Num64 define(ulong x0, ulong x1)
        {
            var dst = default(Num64);
            dst.u64(0,x0);
            dst.u64(1,x1);
        ...
        [MethodImpl(Inline)]
        public static Num64 addu64(Num64 lhs, Num64 rhs)
        {
            var dst = default(Num64);
        ...
        [MethodImpl(Inline)]
        public static Num64 addf32(Num64 lhs, Num64 rhs)
        {
            var dst = default(Num64);
        ...
        [MethodImpl(Inline)]
        public static Num64 define(double src)
        {
            var dst = default(Num64);
            dst.f64_0 = src;
            return dst;
        ...
        [MethodImpl(Inline)]
        public static Num64 addf64(Num64 lhs, Num64 rhs)
            => Num64.define(lhs.f64_0 + rhs.f64_0);
