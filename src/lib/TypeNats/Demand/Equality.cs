...
namespace Z0
{
    ...
    partial class Demands
    {
        ...
        public interface Equal<K1,K2> : Demand<K1,K2>
        ...
        /// <typeparam name="K1">The first nat type</typeparam>
        /// <typeparam name="K2">The second nat type</typeparam>
        public interface Different<K1,K2> : Demand<K1,K2>
            where K1: TypeNat, new()
            where K2: TypeNat, new()
        {
    ...
    /// <typeparam name="N2">The second nat type</typeparam>
     public readonly struct Equal<K1,K2> : Demands.Equal<K1,K2>
        where K1: TypeNat, new()
        where K2: TypeNat, new()
    {
    ...
    /// <typeparam name="K1">The first nat type</typeparam>
    /// <typeparam name="N2">The second nat type</typeparam>
     public readonly struct Different<K1,K2> : Demands.Different<K1,K2>
        where K1: TypeNat, new()
        where K2: TypeNat, new()
    {
        static readonly K1 k1 = default;
