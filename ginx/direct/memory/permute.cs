...
namespace Z0
{
    ...
    partial class dinx
    {
        ...
        [MethodImpl(Inline)]
        public static ref Vec128<float> permute(ref Vec128<float> value, byte control)
        {
            value = Permute(value,control);
            return ref value;
        }

        [MethodImpl(Inline)]
        public static ref Vec128<double> permute(ref Vec128<double> value, byte control)
        {
            value = Permute(value,control);
            return ref value;
        }
