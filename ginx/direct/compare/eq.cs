...
namespace Z0
{
    ...
    partial class dinx
    {
        ...
        [MethodImpl(Inline)]
        public static Bit[] eq(in Vec256<byte> lhs, in Vec256<byte> rhs)
        {
        ...
        [MethodImpl(Inline)]
        public static Bit[] eq(in Vec256<short> lhs, in Vec256<short> rhs)
        {
            var result = CompareEqual(lhs, rhs);
            var x0 = extract(result,0);
            var x1 = extract(result,1);
        ...
        [MethodImpl(Inline)]
        public static Bit[] eq(in Vec256<ushort> lhs, in Vec256<ushort> rhs)
        {
            var result = CompareEqual(lhs, rhs);
            var x0 = extract(result, 0);
            var x1 = extract(result, 1);
        ...
        [MethodImpl(Inline)]
        public static Bit[] eq(in Vec256<int> lhs, in Vec256<int> rhs)
        {
            var result = CompareEqual(lhs, rhs);
            var x0 = extract(result, 0);
            var x1 = extract (result, 1);
        ...
        [MethodImpl(Inline)]
        public static Bit[] eq(in Vec256<uint> lhs, in Vec256<uint> rhs)
        {
            var result = CompareEqual(lhs, rhs);
            var x0 = extract(result, 0);
            var x1 = extract (result, 1);
