...
namespace Z0
{
    ...
    partial class dinx
    {
        ...
        [MethodImpl(Inline)]
        public unsafe static ref readonly Vec128<short> lshift(in Vec128<short> lhs, byte count, ref short dst)
        {
        ...
        [MethodImpl(Inline)]
        public unsafe static ref readonly Vec128<ushort> lshift(in Vec128<ushort> lhs, byte count, ref ushort dst)
        {
            store(lshift(lhs,count), ref dst);
            return ref lhs;
        }
        ...
        [MethodImpl(Inline)]
        public unsafe static ref readonly Vec128<int> lshift(in Vec128<int> lhs, byte count, ref int dst)
        {
            store(lshift(lhs,count), ref dst);
            return ref lhs;
        }
        ...
        [MethodImpl(Inline)]
        public unsafe static ref readonly Vec128<uint> lshift(in Vec128<uint> lhs, byte count, ref uint dst)
        {
            store(lshift(lhs,count), ref dst);
            return ref lhs;
        }
        ...
        [MethodImpl(Inline)]
        public unsafe static ref readonly Vec128<long> lshift(in Vec128<long> lhs, byte count, ref long dst)
        {
            store(lshift(lhs,count), ref dst);
            return ref lhs;
        }
        ...
        [MethodImpl(Inline)]
        public unsafe static ref readonly Vec128<ulong> lshift(in Vec128<ulong> lhs, byte count, ref ulong dst)
        {
            store(lshift(lhs,count), ref dst);
            return ref lhs;
        }
        ...
        [MethodImpl(Inline)]
        public unsafe static ref readonly Vec256<short> lshift(in Vec256<short> lhs, byte count, ref short dst)
        {
            store(lshift(lhs,count), ref dst);
            return ref lhs;
        }
        ...
        [MethodImpl(Inline)]
        public unsafe static ref readonly Vec256<ushort> lshift(in Vec256<ushort> lhs, byte count, ref ushort dst)
        {
            store(lshift(lhs,count), ref dst);
            return ref lhs;
        }
        ...
        [MethodImpl(Inline)]
        public unsafe static ref readonly Vec256<int> lshift(in Vec256<int> lhs, byte count, ref int dst)
        {
            store(lshift(lhs,count), ref dst);
            return ref lhs;
        }
        ...
        [MethodImpl(Inline)]
        public unsafe static ref readonly Vec256<uint> lshift(in Vec256<uint> lhs, byte count, ref uint dst)
        {
            store(lshift(lhs,count), ref dst);
            return ref lhs;
        }
        ...
        [MethodImpl(Inline)]
        public unsafe static ref readonly Vec256<long> lshift(in Vec256<long> lhs, byte count, ref long dst)
        {
            store(lshift(lhs,count), ref dst);
            return ref lhs;
        }
        ...
        [MethodImpl(Inline)]
        public unsafe static ref readonly Vec256<ulong> lshift(in Vec256<ulong> lhs, byte count, ref ulong dst)
        {
            store(lshift(lhs,count), ref dst);
            return ref lhs;
        }
        ...
        public static unsafe ref Span128<short> lshift(ReadOnlySpan128<short> lhs, byte count, ref Span128<short> dst)
        {
            ...
            for(var i =0; i < cells; i += width)
                lshift(lhs.LoadVector(i), count, ref dst[i]);
