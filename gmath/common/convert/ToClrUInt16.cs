...
namespace Z0
{
    ...
    public static class ToUint16X
    {
        [MethodImpl(Inline)]
        public static ushort[] ToUInt16(this byte[] src)
            => map(src,x => (target)x);

        [MethodImpl(Inline)]
        public static ushort[] ToUInt16(this sbyte[] src)
            => map(src,x => (target)x);

        [MethodImpl(Inline)]
        public static ushort[] ToUInt16(this short[] src)
            => map(src,x => (target)x);

        [MethodImpl(Inline)]
        public static ushort[] ToUInt16(this ushort[] src)
            => map(src,x => (target)x);

        [MethodImpl(Inline)]
        public static ushort[] ToUInt16(this int[] src)
            => map(src,x => (target)x);

        [MethodImpl(Inline)]
        public static ushort[] ToUInt16(this uint[] src)
            => map(src,x => (target)x);

        [MethodImpl(Inline)]
        public static ushort[] ToUInt16(this long[] src)
            => map(src,x => (target)x);

        [MethodImpl(Inline)]
        public static ushort[] ToUInt16(this ulong[] src)
            => map(src,x => (target)x);

        [MethodImpl(Inline)]
        public static ushort[] ToUInt16(this float[] src)
            => map(src,x => (target)x);

        [MethodImpl(Inline)]
        public static ushort[] ToUInt16(this double[] src)
            => map(src,x => (target)x);

        [MethodImpl(Inline)]
        public static ushort[] ToUInt16(this decimal[] src)
            => map(src,x => (target)x);

        [MethodImpl(Inline)]
        public static ushort[] ToUInt16(this BigInteger[] src)
            => map(src,x => (target)x);
