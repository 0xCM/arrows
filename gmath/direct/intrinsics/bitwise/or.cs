...
namespace Z0
{
    ...
    partial class dinx
    {
        ...
        public static unsafe ref sbyte[] or(in sbyte[] lhs, in sbyte[] rhs, ref sbyte[] dst)
        {
        ...
        public static unsafe ref byte[] or(in byte[] lhs, in byte[] rhs, ref byte[] dst)
        {
        ...
        public static unsafe ref short[] or(in short[] lhs, in short[] rhs, ref short[] dst)
        {
        ...
        public static unsafe ref ushort[] or(in ushort[] lhs, in ushort[] rhs, ref ushort[] dst)
        {
        ...
        public static unsafe ref int[] or(in int[] lhs, in int[] rhs, ref int[] dst)
        {
        ...
        public static unsafe ref uint[] or(in uint[] lhs, in uint[] rhs, ref uint[] dst)
        {
        ...
        public static unsafe ref long[] or(in long[] lhs, in long[] rhs, ref long[] dst)
        {
        ...
        public static unsafe ref ulong[] or(in ulong[] lhs, in ulong[] rhs, ref ulong[] dst)
        {
        ...
        public static unsafe ref float[] or(in float[] lhs, in float[] rhs, ref float[] dst)
        {
        ...
        public static unsafe ref double[] or(in double[] lhs, in double[] rhs, ref double[] dst)
        {
