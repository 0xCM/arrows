...
namespace Z0
{
    ...
    public static partial class math
    {
        ...
        [MethodImpl(Inline)]
        public static void mul(ReadOnlySpan<sbyte> lhs, ReadOnlySpan<sbyte> rhs, Span<sbyte> dst)
        {
            var len = length(lhs,rhs);
            for(var i = 0; i< len; i++)
        ...
        [MethodImpl(Inline)]
        public static void mul(ReadOnlySpan<byte> lhs, ReadOnlySpan<byte> rhs, Span<byte> dst)
        {
            var len = length(lhs,rhs);
            for(var i = 0; i< len; i++)
                dst[i] = mul(lhs[i], rhs[i]);
        ...
        [MethodImpl(Inline)]
        public static void mul(ReadOnlySpan<short> lhs, ReadOnlySpan<short> rhs, Span<short> dst)
        {
            var len = length(lhs,rhs);
            for(var i = 0; i< len; i++)
                dst[i] = mul(lhs[i], rhs[i]);
        ...
        [MethodImpl(Inline)]
        public static void mul(ReadOnlySpan<ushort> lhs, ReadOnlySpan<ushort> rhs, Span<ushort> dst)
        {
            var len = length(lhs,rhs);
            for(var i = 0; i< len; i++)
                dst[i] = mul(lhs[i], rhs[i]);
        ...
        [MethodImpl(Inline)]
        public static void mul(ReadOnlySpan<int> lhs, ReadOnlySpan<int> rhs, Span<int> dst)
        {
            var len = length(lhs,rhs);
            for(var i = 0; i< len; i++)
                dst[i] = mul(lhs[i], rhs[i]);
        ...
        [MethodImpl(Inline)]
        public static void mul(ReadOnlySpan<uint> lhs, ReadOnlySpan<uint> rhs, Span<uint> dst)
        {
            var len = length(lhs,rhs);
            for(var i = 0; i< len; i++)
                dst[i] = mul(lhs[i], rhs[i]);
        ...
        [MethodImpl(Inline)]
        public static void mul(ReadOnlySpan<long> lhs, ReadOnlySpan<long> rhs, Span<long> dst)
        {
            var len = length(lhs,rhs);
            for(var i = 0; i< len; i++)
                dst[i] = mul(lhs[i], rhs[i]);
        ...
        [MethodImpl(Inline)]
        public static void mul(ReadOnlySpan<ulong> lhs, ReadOnlySpan<ulong> rhs, Span<ulong> dst)
        {
            var len = length(lhs,rhs);
            for(var i = 0; i< len; i++)
                dst[i] = mul(lhs[i], rhs[i]);
        ...
        [MethodImpl(Inline)]
        public static void mul(ReadOnlySpan<float> lhs, ReadOnlySpan<float> rhs, Span<float> dst)
        {
            var len = length(lhs,rhs);
            for(var i = 0; i< len; i++)
                dst[i] = mul(lhs[i], rhs[i]);
        ...
        [MethodImpl(Inline)]
        public static void mul(ReadOnlySpan<double> lhs, ReadOnlySpan<double> rhs, Span<double> dst)
        {
            var len = length(lhs,rhs);
            for(var i = 0; i< len; i++)
                dst[i] = mul(lhs[i], rhs[i]);
