...
namespace Z0
{
    ...
    public static class MetricComparer
    {
        ...
        public static MetricComparisonRecord Run(this MetricComparisonSpec spec, MetricConfig config = null)
        {            
         ...
         public static IEnumerable<MetricComparisonRecord> Run(this IEnumerable<MetricComparisonSpec> specs, MetricConfig config = null)
         {
