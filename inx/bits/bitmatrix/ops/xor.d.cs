...
namespace Z0
{
    ...
    {    
        ...
        [MethodImpl(Inline)]
        public static ref BitMatrix4 XOr(this ref BitMatrix4 lhs, in BitMatrix4 rhs)
        {
        ...
        public static ref BitMatrix32 XOr(this ref BitMatrix32 lhs, in BitMatrix32 rhs)
        {
            const int rowstep = 8;
        ...
        public static ref BitMatrix64 XOr(this ref BitMatrix64 lhs, in BitMatrix64 rhs)
        {
            const int rowstep = 4;
            for(var i=0; i< lhs.RowDim; i += rowstep)
            {
