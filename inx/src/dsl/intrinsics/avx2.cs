...
namespace Z0
{
    ...
    partial class x86
    {
        ...
        /// </summary>
        [MethodImpl(Inline)]
        public static unsafe __m128i _mm_mask_i64gather_epi64(in __m128i src, ref ulong base_addr, in __m128i index, in __m128i mask, byte scale)
            => GatherMaskVector128(v64u(src), refptr(ref base_addr), v32i(index), v64u(mask), scale);
        ...
        /// </summary>
        [MethodImpl(Inline)]
        public static unsafe __m128i _mm_mask_i32gather_epi64(in __m128i src, ref ulong base_addr, in __m128i index, in __m128i mask, byte scale)
            => GatherMaskVector128(v64u(src), refptr(ref base_addr), v32i(index), v64u(mask), scale);
