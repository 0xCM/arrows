...
namespace Z0
{
    ...
    partial class x86
    {
        ...
        ///<intrinsic>__m128d _mm_unpacklo_pd (in __m128d a, in __m128d b) UNPCKLPD xmm, xmm/m128</intrinsic>
        [MethodImpl(Inline)]
        public static __m128d _mm_unpacklo_pd(in __m128d a, in __m128d b)
            => UnpackLow(a, b);

        ///<intrinsic>m128i _mm_unpackhi_epi8 (__m128i a, __m128i b) PUNPCKHBW xmm, xmm/m128
        [MethodImpl(Inline)]
        public static __m128i _mm_unpackhi_epi8(in __m128i a, in __m128i b)
            => UnpackHigh(v8i(a),v8i(b));

        ///<intrinsic>m128i _mm_unpackhi_epi16 (__m128i a, __m128i b) PUNPCKHWD xmm, xmm/m128
        [MethodImpl(Inline)]
        public static __m128i _mm_unpackhi_epi16(in __m128i a, in __m128i b)
            => UnpackHigh(v16i(a),v16i(b));
                
        ///<intrinsic>m128i _mm_unpackhi_epi32 (__m128i a, __m128i b) PUNPCKHDQ xmm, xmm/m128
        [MethodImpl(Inline)]
        public static __m128i _mm_unpackhi_epi32(in __m128i a, __m128i b)
            => UnpackHigh(v32i(a),v32i(b));

        ///<intrinsic>m128i _mm_unpackhi_epi64 (__m128i a, __m128i b) PUNPCKHQDQ xmm, xmm/m128
        [MethodImpl(Inline)]
        public static __m128i _mm_unpackhi_epi64(in __m128i a, in __m128i b)
            => UnpackHigh(v64i(a),v64i(b));

        ///<intrinsic>m128d _mm_unpackhi_pd (in __m128d a, in __m128d b) UNPCKHPD xmm, xmm/m128
        [MethodImpl(Inline)]
        public static __m128d _mm_unpackhi_pd(in __m128d a, in __m128d b)
            => UnpackHigh(a,b);

        ///<intrinsic>m128d _mm_xor_pd (in __m128d a, in __m128d b) XORPD xmm, xmm/m128        
        [MethodImpl(Inline)]
        public static __m128d _mm_xor_pd(in __m128d a, in __m128d b)
            => Xor(a, b);

        ///<intrinsic>m128d _mm_add_pd (in __m128d a, in __m128d b) ADDPD xmm, xmm/m128</intrinsic>
        [MethodImpl(Inline)]
        public static __m128d _mm_add_pd(in __m128d a, in __m128d b)
            => Add(a,b);

        ///<intrinsic>m128d _mm_cmpgt_pd (in __m128d a, in __m128d b) CMPPD xmm, xmm/m128, imm8(6) </intrinsic>
        [MethodImpl(Inline)]
        public static __m128d _mm_cmpgt_pd(in __m128d a, in __m128d b)
            => CompareGreaterThan(a,b);

        ///<intrinsic>m128d _mm_add_sd (in __m128d a, in __m128d b) ADDSD xmm, xmm/m64
        [MethodImpl(Inline)]
        public static __m128d _mm_add_sd(in __m128d a, in __m128d b)
            => AddScalar(a,b);

        ///<intrinsic>m128d _mm_mul_sd (in __m128d a, in __m128d b) MULSD xmm, xmm/m64</intrinsic>
        [MethodImpl(Inline)]
        public static __m128d _mm_mul_sd(in __m128d a, in __m128d b)
            => MultiplyScalar(a, b);

        ///<intrinsic>m128d _mm_mul_pd (in __m128d a, in __m128d b) MULPD xmm, xmm/m128
        [MethodImpl(Inline)]
        public static __m128d _mm_mul_pd(in __m128d a, in __m128d b)
            => Multiply(a,b);

        ///<intrinsic>m128d _mm_max_pd (in __m128d a, in __m128d b) MAXPD xmm, xmm/m128
        [MethodImpl(Inline)]
        public static __m128d _mm_max_pd(in __m128d a, in __m128d b)
            => Max(a,b);
        
        ///<intrinsic>m128d _mm_max_sd (in __m128d a, in __m128d b) MAXSD xmm, xmm/m64
        [MethodImpl(Inline)]
        public static __m128d _mm_max_sd(in __m128d a, in __m128d b)
            => MaxScalar(a,b);

        ///<intrinsic>m128d _mm_load_pd (double const* mem_address) MOVAPD xmm, m128
        [MethodImpl(Inline)]
        public static unsafe __m128d _mm_load_pd(ref double mem_address)
            => LoadAlignedVector128(refptr(ref mem_address));

        ///<intrinsic>m128d _mm_loadu_pd (double const* mem_address) MOVUPD xmm, m128
...
/*
        ...
        ///<intrinsic>m128i _mm_adds_epu8 (__m128i a, __m128i b) PADDUSB xmm, xmm/m128</intrinsic>
        [MethodImpl(Inline)]
        public static Vector128<byte> AddSaturate(Vector128<byte> a, Vector128<byte> b)
        
        ///<intrinsic>m128i _mm_adds_epi16 (__m128i a, __m128i b) PADDSW xmm, xmm/m128</intrinsic>
        [MethodImpl(Inline)]
        public static Vector128<short> AddSaturate(Vector128<short> a, Vector128<short> b)
        
        ///<intrinsic>m128i _mm_adds_epi8 (__m128i a, __m128i b) PADDSB xmm, xmm/m128</intrinsic>
        [MethodImpl(Inline)]
        public static Vector128<sbyte> AddSaturate(Vector128<sbyte> a, Vector128<sbyte> b)
        
        ///<intrinsic>m128i _mm_adds_epu16 (__m128i a, __m128i b) PADDUSW xmm, xmm/m128</intrinsic>
        [MethodImpl(Inline)]
        public static Vector128<ushort> AddSaturate(Vector128<ushort> a, Vector128<ushort> b)
        

        ///<intrinsic>m128i _mm_and_si128 (__m128i a, __m128i b) PAND xmm, xmm/m128</intrinsic>
        [MethodImpl(Inline)]
        ...
        ///<intrinsic>m128d _mm_and_pd (in __m128d a, in __m128d b) ANDPD xmm, xmm/m128</intrinsic>
        public static __m128d And(in __m128d a, in __m128d b)
        ...
        ///<intrinsic>m128i _mm_andnot_si128 (__m128i a, __m128i b) PANDN xmm, xmm/m128</intrinsic>
        ...
        ///<intrinsic>m128d _mm_andnot_pd (in __m128d a, in __m128d b) ADDNPD xmm, xmm/m128</intrinsic>
        public static __m128d AndNot(in __m128d a, in __m128d b)
        //
        ...
        ///<intrinsic>m128i _mm_avg_epu8 (__m128i a, __m128i b) PAVGB xmm, xmm/m128</intrinsic>
        public static Vector128<byte> Average(Vector128<byte> a, Vector128<byte> b)
        
        ///<intrinsic>m128i _mm_avg_epu16 (__m128i a, __m128i b) PAVGW xmm, xmm/m128</intrinsic>
        public static Vector128<ushort> Average(Vector128<ushort> a, Vector128<ushort> b)
        
        ///<intrinsic>m128i _mm_cmpeq_epi16 (__m128i a, __m128i b) PCMPEQW xmm, xmm/m128</intrinsic>
        public static Vector128<ushort> CompareEqual(Vector128<ushort> a, Vector128<ushort> b)
        
        ///<intrinsic>m128i _mm_cmpeq_epi8 (__m128i a, __m128i b) PCMPEQB xmm, xmm/m128</intrinsic>
        public static Vector128<sbyte> CompareEqual(Vector128<sbyte> a, Vector128<sbyte> b)
        
        ///<intrinsic>m128i _mm_cmpeq_epi32 (__m128i a, __m128i b) PCMPEQD xmm, xmm/m128</intrinsic>
        ...
        ///<intrinsic>m128d _mm_cmpeq_pd (in __m128d a, in __m128d b) CMPPD xmm, xmm/m128</intrinsic>, imm8(0)
        public static __m128d CompareEqual(in __m128d a, in __m128d b)
        ...
        ///<intrinsic>m128i _mm_cmpgt_epi8 (__m128i a, __m128i b) PCMPGTB xmm, xmm/m128</intrinsic>
        public static Vector128<sbyte> CompareGreaterThan(Vector128<sbyte> a, Vector128<sbyte> b)
        //
        
        
        ///<intrinsic>m128i _mm_cmpgt_epi16 (__m128i a, __m128i b) PCMPGTW xmm, xmm/m128</intrinsic>
        public static Vector128<short> CompareGreaterThan(Vector128<short> a, Vector128<short> b)
        //
        
        ///<intrinsic>m128i _mm_cmpgt_epi32 (__m128i a, __m128i b) PCMPGTD xmm, xmm/m128</intrinsic>
        public static Vector128<int> CompareGreaterThan(Vector128<int> a, Vector128<int> b)
        //
        
        ///<intrinsic>m128d _mm_cmpge_pd (in __m128d a, in __m128d b) CMPPD xmm, xmm/m128, imm8(5)
        public static __m128d CompareGreaterThanOrEqual(in __m128d a, in __m128d b)
        
        ///<intrinsic>m128d _mm_cmplt_pd (in __m128d a, in __m128d b) CMPPD xmm, xmm/m128, imm8(1)
        public static __m128d CompareLessThan(in __m128d a, in __m128d b)
        
        ///<intrinsic>m128i _mm_cmplt_epi16 (__m128i a, __m128i b) PCMPGTW xmm, xmm/m128
        public static Vector128<short> CompareLessThan(Vector128<short> a, Vector128<short> b)
        
        ///<intrinsic>m128i _mm_cmplt_epi32 (__m128i a, __m128i b) PCMPGTD xmm, xmm/m128
        public static Vector128<int> CompareLessThan(Vector128<int> a, Vector128<int> b)
        
        ///<intrinsic>m128i _mm_cmplt_epi8 (__m128i a, __m128i b) PCMPGTB xmm, xmm/m128
        public static Vector128<sbyte> CompareLessThan(Vector128<sbyte> a, Vector128<sbyte> b)
        
        ///<intrinsic>m128d _mm_cmple_pd (in __m128d a, in __m128d b) CMPPD xmm, xmm/m128, imm8(2)
        public static __m128d CompareLessThanOrEqual(in __m128d a, in __m128d b)
        
        ///<intrinsic>m128d _mm_cmpneq_pd (in __m128d a, in __m128d b) CMPPD xmm, xmm/m128, imm8(4)
        public static __m128d CompareNotEqual(in __m128d a, in __m128d b)
        
        ///<intrinsic>m128d _mm_cmpngt_pd (in __m128d a, in __m128d b) CMPPD xmm, xmm/m128, imm8(2)
        public static __m128d CompareNotGreaterThan(in __m128d a, in __m128d b)
        
        ///<intrinsic>m128d _mm_cmpnge_pd (in __m128d a, in __m128d b) CMPPD xmm, xmm/m128, imm8(1)
        public static __m128d CompareNotGreaterThanOrEqual(in __m128d a, in __m128d b)
        
        ///<intrinsic>m128d _mm_cmpnlt_pd (in __m128d a, in __m128d b) CMPPD xmm, xmm/m128, imm8(5)
        public static __m128d CompareNotLessThan(in __m128d a, in __m128d b)
        
        ///<intrinsic>m128d _mm_cmpnle_pd (in __m128d a, in __m128d b) CMPPD xmm, xmm/m128, imm8(6)
        public static __m128d CompareNotLessThanOrEqual(in __m128d a, in __m128d b)
        //
        
        ///<intrinsic>m128d _mm_cmpord_pd (in __m128d a, in __m128d b) CMPPD xmm, xmm/m128, imm8(7)
        ...
        ///<intrinsic>m128d _mm_cmpunord_pd (in __m128d a, in __m128d b) CMPPD xmm, xmm/m128, imm8(3)
        public static __m128d CompareUnordered(in __m128d a, in __m128d b)
        //
        
        ///<intrinsic>m128d _mm_cvtsi32_sd (__m128d a, int b) CVTSI2SD xmm, reg/m32
        public static __m128d ConvertScalarToVector128Double(__m128d upper, int value)
        //
        
        ///<intrinsic>m128d _mm_cvtss_sd (__m128d a, __m128 b) CVTSS2SD xmm, xmm/m32
        public static __m128d ConvertScalarToVector128Double(__m128d upper, Vector128<float> value)
        //
        
        ///<intrinsic>m128i _mm_cvtsi32_si128 (int a) MOVD xmm, reg/m32
        public static Vector128<int> ConvertScalarToVector128Int32(int value)
        //
        
        ///<intrinsic>m128 _mm_cvtsd_ss (__m128 a, __m128d b) CVTSD2SS xmm, xmm/m64
        public static Vector128<float> ConvertScalarToVector128Single(Vector128<float> upper, __m128d value)
        //
        ...
        ///<intrinsic>int _mm_cvtsd_si32 (__m128d a) CVTSD2SI r32, xmm/m64
        public static int ConvertToInt32(__m128d value)
        
        ///<intrinsic>int _mm_cvtsi128_si32 (__m128i a) MOVD reg/m32, xmm
        public static int _mm_cvtsi128_si32(Vector128<int> a)
            => ConvertToInt32(a);
        
        ///<intrinsic>int _mm_cvttsd_si32 (__m128d a) CVTTSD2SI reg, xmm/m64
        public static int ConvertToInt32WithTruncation(__m128d value)
        
        ///<intrinsic>int _mm_cvtsi128_si32 (__m128i a) MOVD reg/m32, xmm
        public static uint ConvertToUInt32(Vector128<uint> value)
        
        ///<intrinsic>m128d _mm_cvtepi32_pd (__m128i a) CVTDQ2PD xmm, xmm/m128
        public static __m128d ConvertToVector128Double(Vector128<int> value)
        
        ///<intrinsic>m128d _mm_cvtps_pd (__m128 a) CVTPS2PD xmm, xmm/m128
        public static __m128d ConvertToVector128Double(Vector128<float> value)
        
        ///<intrinsic>m128i _mm_cvtpd_epi32 (__m128d a) CVTPD2DQ xmm, xmm/m128
        public static Vector128<int> ConvertToVector128Int32(__m128d value)
        
        ///<intrinsic>m128i _mm_cvtps_epi32 (__m128 a) CVTPS2DQ xmm, xmm/m128
        public static Vector128<int> ConvertToVector128Int32(Vector128<float> value)
        
        ///<intrinsic>m128i _mm_cvttpd_epi32 (__m128d a) CVTTPD2DQ xmm, xmm/m128
        public static Vector128<int> ConvertToVector128Int32WithTruncation(__m128d value)
        
        ///<intrinsic>m128i _mm_cvttps_epi32 (__m128 a) CVTTPS2DQ xmm, xmm/m128
        public static Vector128<int> ConvertToVector128Int32WithTruncation(Vector128<float> value)
        
        ///<intrinsic>m128 _mm_cvtpd_ps (__m128d a) CVTPD2PS xmm, xmm/m128
        public static Vector128<float> ConvertToVector128Single(__m128d value)
        
        ///<intrinsic>m128 _mm_cvtepi32_ps (__m128i a) CVTDQ2PS xmm, xmm/m128
        public static Vector128<float> ConvertToVector128Single(Vector128<int> value)
        
        ///<intrinsic>m128d _mm_div_pd (in __m128d a, in __m128d b) DIVPD xmm, xmm/m128
        public static __m128d Divide(in __m128d a, in __m128d b)
        
        ///<intrinsic>m128d _mm_div_sd (in __m128d a, in __m128d b) DIVSD xmm, xmm/m64
        public static __m128d DivideScalar(in __m128d a, in __m128d b)
        
        ///<intrinsic>int _mm_extract_epi16 (__m128i a, int immediate) PEXTRW reg, xmm, imm8
        public static ushort Extract(Vector128<ushort> value, byte index)
        
        ///<intrinsic>m128i _mm_insert_epi16 (__m128i a, int i, int immediate) PINSRW xmm, reg/m16, imm8
        ...
        ///<intrinsic>m128i _mm_load_si128 (__m128i const* mem_address) MOVDQA xmm, m128
        ...
        ///<intrinsic>m128d _mm_loadh_pd (__m128d a, double const* mem_addr) MOVHPD xmm, m64
        public static __m128d LoadHigh(__m128d lower, double* address)
        
        ///<intrinsic>m128d _mm_loadl_pd (__m128d a, double const* mem_addr) MOVLPD xmm, m64
        public static __m128d LoadLow(__m128d upper, double* address)
        
        ///<intrinsic>m128d _mm_load_sd (double const* mem_address) MOVSD xmm, m64
        ...
        ///<intrinsic>m128i _mm_loadl_epi32 (__m128i const* mem_addr) MOVD xmm, reg/m32
        public static Vector128<int> LoadScalarVector128(int* address)
        
        ///<intrinsic>m128i _mm_loadl_epi64 (__m128i const* mem_addr) MOVQ xmm, reg/m64
        ...
        ///<intrinsic>m128i _mm_loadu_si128 (__m128i const* mem_address) MOVDQU xmm, m128
        ...
        ///<intrinsic>m128i _mm_max_epi16 (__m128i a, __m128i b) PMAXSW xmm, xmm/m128
        public static Vector128<short> Max(Vector128<short> a, Vector128<short> b)
        
        ///<intrinsic>m128i _mm_max_epu8 (__m128i a, __m128i b) PMAXUB xmm, xmm/m128
        ...
        ///<intrinsic>m128d _mm_min_pd (in __m128d a, in __m128d b) MINPD xmm, xmm/m128
        public static __m128d Min(in __m128d a, in __m128d b)
        //
        
        ///<intrinsic>m128i _mm_min_epi16 (__m128i a, __m128i b) PMINSW xmm, xmm/m128
        public static Vector128<short> Min(Vector128<short> a, Vector128<short> b)
        //
        
        ///<intrinsic>m128i _mm_min_epu8 (__m128i a, __m128i b) PMINUB xmm, xmm/m128
        public static Vector128<byte> Min(Vector128<byte> a, Vector128<byte> b)
        //
        
        ///<intrinsic>m128d _mm_min_sd (in __m128d a, in __m128d b) MINSD xmm, xmm/m64
        ...
        ///<intrinsic>m128d _mm_move_sd (in __m128d a, in __m128d b) MOVSD xmm, xmm
        public static __m128d MoveScalar(__m128d upper, __m128d value)
        //
        
        ///<intrinsic>m128i _mm_move_epi64 (__m128i a) MOVQ xmm, xmm
        ...
        ///<intrinsic>m128i _mm_mul_epu32 (__m128i a, __m128i b) PMULUDQ xmm, xmm/m128
        public static Vector128<ulong> Multiply(Vector128<uint> a, Vector128<uint> b)
        //
        
        //
        
        ///<intrinsic>m128i _mm_madd_epi16 (__m128i a, __m128i b) PMADDWD xmm, xmm/m128
        public static Vector128<int> MultiplyAddAdjacent(Vector128<short> a, Vector128<short> b)
        //
        
        ///<intrinsic>m128i _mm_mulhi_epu16 (__m128i a, __m128i b) PMULHUW xmm, xmm/m128
        public static Vector128<ushort> MultiplyHigh(Vector128<ushort> a, Vector128<ushort> b)
        //
        
        ///<intrinsic>m128i _mm_mulhi_epi16 (__m128i a, __m128i b) PMULHW xmm, xmm/m128
        public static Vector128<short> MultiplyHigh(Vector128<short> a, Vector128<short> b)
        //
        
        ///<intrinsic>m128i _mm_mullo_epi16 (__m128i a, __m128i b) PMULLW xmm, xmm/m128
        ...
        ///<intrinsic>m128i _mm_or_si128 (__m128i a, __m128i b) POR xmm, xmm/m128
        ...
        ///<intrinsic>m128d _mm_or_pd (in __m128d a, in __m128d b) ORPD xmm, xmm/m128
        ...
        ///<intrinsic>m128i _mm_slli_epi16 (__m128i a, int immediate) PSLLW xmm, imm8
        ...
        ///<intrinsic>m128i _mm_bslli_si128 (__m128i a, int imm8) PSLLDQ xmm, imm8
        ...
        ///<intrinsic>m128i _mm_bsrli_si128 (__m128i a, int imm8) PSRLDQ xmm, imm8
        ...
        ///<intrinsic>m128d _mm_shuffle_pd (in __m128d a, in __m128d b, int immediate) SHUFPD xmm, xmm/m128, imm8
        public static __m128d Shuffle(in __m128d a, in __m128d b, byte control)
        
        ///<intrinsic>m128i _mm_shuffle_epi32 (__m128i a, int immediate) PSHUFD xmm, xmm/m128, imm8
        ...
        ///<intrinsic>m128i _mm_shufflehi_epi16 (__m128i a, int immediate) PSHUFHW xmm, xmm/m128, imm8
        public static Vector128<short> ShuffleHigh(Vector128<short> value, byte control)
        
        ///<intrinsic>m128i _mm_shufflehi_epi16 (__m128i a, int control) PSHUFHW xmm, xmm/m128, imm8
        public static Vector128<ushort> ShuffleHigh(Vector128<ushort> value, byte control)
        
        ///<intrinsic>m128i _mm_shufflelo_epi16 (__m128i a, int control) PSHUFLW xmm, xmm/m128, imm8
        ...
        ///<intrinsic>m128d _mm_sqrt_pd (__m128d a) SQRTPD xmm, xmm/m128
        public static __m128d Sqrt(__m128d value)
        
        ///This native signature does not exist. 
        ///<intrinsic>m128d _mm_sqrt_sd (__m128d a) SQRTSD xmm, xmm/64 
        public static __m128d SqrtScalar(__m128d value)
        
        ///<intrinsic>m128d _mm_sqrt_sd (in __m128d a, in __m128d b) SQRTSD xmm, xmm/64
        ...
        ///<intrinsic>m128i _mm_sub_epi16 (__m128i a, __m128i b) PSUBW xmm, xmm/m128
        public static Vector128<ushort> Subtract(Vector128<ushort> a, Vector128<ushort> b)
        //
        
        ///<intrinsic>m128i _mm_sub_epi64 (__m128i a, __m128i b) PSUBQ xmm, xmm/m128
        public static Vector128<ulong> Subtract(Vector128<ulong> a, Vector128<ulong> b)
        //
        
        ///<intrinsic>m128i _mm_sub_epi8 (__m128i a, __m128i b) PSUBB xmm, xmm/m128
        public static Vector128<sbyte> Subtract(Vector128<sbyte> a, Vector128<sbyte> b)
        //
        
        ///<intrinsic>m128i _mm_sub_epi32 (__m128i a, __m128i b) PSUBD xmm, xmm/m128
        ...
        ///<intrinsic>m128d _mm_sub_pd (in __m128d a, in __m128d b) SUBPD xmm, xmm/m128
        ...
        ///<intrinsic>m128i _mm_subs_epu8 (__m128i a, __m128i b) PSUBUSB xmm, xmm/m128
        public static Vector128<byte> SubtractSaturate(Vector128<byte> a, Vector128<byte> b)
        //
        
        ///<intrinsic>m128i _mm_subs_epi16 (__m128i a, __m128i b) PSUBSW xmm, xmm/m128
        public static Vector128<short> SubtractSaturate(Vector128<short> a, Vector128<short> b)
        //
        
        ///<intrinsic>m128i _mm_subs_epi8 (__m128i a, __m128i b) PSUBSB xmm, xmm/m128
        public static Vector128<sbyte> SubtractSaturate(Vector128<sbyte> a, Vector128<sbyte> b)
        //
        
        ///<intrinsic>m128i _mm_subs_epu16 (__m128i a, __m128i b) PSUBUSW xmm, xmm/m128
        public static Vector128<ushort> SubtractSaturate(Vector128<ushort> a, Vector128<ushort> b)
        //
        
        ///<intrinsic>m128d _mm_sub_sd (in __m128d a, in __m128d b) SUBSD xmm, xmm/m64
        public static __m128d SubtractScalar(in __m128d a, in __m128d b)
        //
        
        ///<intrinsic>m128i _mm_sad_epu8 (__m128i a, __m128i b) PSADBW xmm, xmm/m128
        public static Vector128<ushort> SumAbsoluteDifferences(Vector128<byte> a, Vector128<byte> b)            
        

        ///<intrinsic>m128i _mm_unpacklo_epi8 (__m128i a, __m128i b) PUNPCKLBW xmm, xmm/m128
        public static Vector128<sbyte> _mm_unpacklo_epi8(__m128i a, __m128i b)
            => UnpackLow(v8i(a),v8i(b));


        ///<intrinsic>m128i _mm_unpacklo_epi16 (__m128i a, __m128i b) PUNPCKLWD xmm, xmm/m128
        public static Vector128<ushort> UnpackLow(Vector128<ushort> a, Vector128<ushort> b)
        
        ///<intrinsic>m128i _mm_unpacklo_epi32 (__m128i a, __m128i b) PUNPCKLDQ xmm, xmm/m128
        public static Vector128<uint> UnpackLow(Vector128<uint> a, Vector128<uint> b)

        ///<intrinsic>m128i _mm_unpacklo_epi64 (__m128i a, __m128i b) PUNPCKLQDQ xmm, xmm/m128
        public static Vector128<ulong> UnpackLow(Vector128<ulong> a, Vector128<ulong> b)
                        
        ///<intrinsic>m128i _mm_xor_si128 (__m128i a, __m128i b) PXOR xmm, xmm/m128
       ...
       public static Vector128<ulong> Xor(Vector128<ulong> a, Vector128<ulong> b)
        ...
        ///<intrinsic>m128d _mm_cvtsi64_sd (__m128d a, __int64 b) CVTSI2SD xmm, reg/m64
        [MethodImpl(Inline)]
        public static __m128d ConvertScalarToVector128Double(__m128d a, long b)

        ///<intrinsic>m128i _mm_cvtsi64_si128 (__int64 a) MOVQ xmm, reg/m64
        [MethodImpl(Inline)]
        ...
        ///<intrinsic>int64 _mm_cvtsd_si64 (__m128d a) CVTSD2SI r64, xmm/m64
        [MethodImpl(Inline)]
        public static long ConvertToInt64(__m128d value)

        ///<intrinsic>int64 _mm_cvtsi128_si64 (__m128i a) MOVQ reg/m64, xmm
        [MethodImpl(Inline)]
        public static long ConvertToInt64(Vector128<long> a)

        ///<intrinsic>int64 _mm_cvttsd_si64 (__m128d a) CVTTSD2SI reg, xmm/m64
        [MethodImpl(Inline)]
        ...
        ///<intrinsic>void _mm_stream_si64(__int64 *p, __int64 a) MOVNTI m64, r64
        [MethodImpl(Inline)]
