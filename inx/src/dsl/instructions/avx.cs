...
namespace Z0
{
    ...
    partial class x86
    {
        ...
        ///<summary> __m128 _mm_broadcast_ss (float const * mem_addr) VBROADCASTSS xmm, in m32 </summary>
        [MethodImpl(Inline)]
        public static unsafe __m128 _mm_broadcast_ss(ref float mem_addr)
            => BroadcastScalarToVector128(As.pfloat32(ref mem_addr));
        
        ///<summary> __m256d _mm256_broadcast_sd (double const * mem_addr) VBROADCASTSD ymm, in m64 </summary>
        [MethodImpl(Inline)]
        public static unsafe __m256d _mm256_broadcast_sd(ref double mem_addr)
            => BroadcastScalarToVector256(As.pfloat64(ref mem_addr));
        
        ///<summary> __m256 _mm256_broadcast_ss (float const * mem_addr) VBROADCASTSS ymm, in m32 </summary>
        [MethodImpl(Inline)]
        public static unsafe __m256 _mm256_broadcast_ss(ref float mem_addr)
            => BroadcastScalarToVector256(As.pfloat32(ref mem_addr));
        
        ///<summary> __m256d _mm256_broadcast_pd (__m128d const * mem_addr) VBROADCASTF128, ymm, in __m128 </summary>
        [MethodImpl(Inline)]
        ...
        ///<summary> __m256 _mm256_broadcast_ps (__m128 const * mem_addr) VBROADCASTF128, ymm, in __m128 </summary>
        [MethodImpl(Inline)]
        ...
        ///<summary> __m256d _mm256_max_pd (__m256d a, __m256d b) VMAXPD ymm, ymm, ymm/m256
        [MethodImpl(Inline)]
        public static __m256d _mm256_max_pd(in __m256d a, in __m256d b)
            => Max(a,b);
        
        ///<summary> __m256 _mm256_max_ps (__m256 a, __m256 b) VMAXPS ymm, ymm, ymm/m256
        [MethodImpl(Inline)]
        public static __m256 _mm256_max_ps(in __m256 a, in __m256 b)
            => Max(a,b);
        
        ///<summary> __m256d _mm256_min_pd (__m256d a, __m256d b) VMINPD ymm, ymm, ymm/m256
        [MethodImpl(Inline)]
        public static __m256d _mm256_min_pd(in __m256d a, in __m256d b)
            => Min(a,b);
        
        ///<summary> __m256 _mm256_min_ps (__m256 a, __m256 b) VMINPS ymm, ymm, ymm/m256
        [MethodImpl(Inline)]
        public static __m256 _mm256_min_ps(in __m256 a, in __m256 b)
            => Min(a,b);

        //<summary> __m256d _mm256_sqrt_pd (__m256d a) VSQRTPD ymm, ymm/m256
        [MethodImpl(Inline)]
        public static __m256d _mm256_sqrt_pd(in __m256d a)
            => Sqrt(a);
        
        //<summary> __m256 _mm256_sqrt_ps (__m256 a) VSQRTPS ymm, ymm/m256
        [MethodImpl(Inline)]
        ...
        ///<summary> __m256d _mm256_mul_pd (__m256d a, __m256d b) VMULPD ymm, ymm, ymm/m256
        [MethodImpl(Inline)]
        public static __m256d _mm256_mul_pd(in __m256d a, in __m256d b)
            => Multiply(a,b);
        
        ///<summary> __m256 _mm256_mul_ps (__m256 a, __m256 b) VMULPS ymm, ymm, ymm/m256
        [MethodImpl(Inline)]
        ...
        ///<summary> __m256i _mm256_load_si256 (__m256i const * mem_addr) VMOVDQA ymm, in __m256 </summary>
        [MethodImpl(Inline)]
        ...
        ///<summary> __m256i _mm256_lddqu_si256 (__m256i const * mem_addr) VLDDQU ymm, in __m256 </summary>
        [MethodImpl(Inline)]
        ...
        ///<summary> __m256i _mm256_loadu_si256 (__m256i const * mem_addr) VMOVDQU ymm, in __m256 </summary>
        [MethodImpl(Inline)]
        ...
        ///<summary> __m128d _mm_maskload_pd (double const * mem_addr, __m128i mask) VMASKMOVPD xmm, xmm, in __m128 </summary>
        [MethodImpl(Inline)]
        public static unsafe __m128d _mm_maskload_pd(ref double mem_addr, in __m128d mask)
            => MaskLoad(refptr(ref mem_addr), mask);
        
        ///<summary> __m256d _mm256_maskload_pd (double const * mem_addr, __m256i mask) VMASKMOVPD ymm, ymm, in __m256 </summary>
        [MethodImpl(Inline)]
        public static unsafe __m256d _mm256_maskload_pd(ref double mem_addr, in __m256d mask)
            => MaskLoad(refptr(ref mem_addr), mask);
        
        ///<summary> __m128 _mm_maskload_ps (float const * mem_addr, __m128i mask) VMASKMOVPS xmm, xmm, in __m128 </summary> 
        [MethodImpl(Inline)]
        public static unsafe __m128 _mm_maskload_ps(ref float mem_addr, in __m128 mask)
            => MaskLoad(refptr(ref mem_addr), mask);
        
        ///<summary> __m256 _mm256_maskload_ps (float const * mem_addr, __m256i mask) VMASKMOVPS ymm, ymm, in __m256 </summary> 
        [MethodImpl(Inline)]
        public static unsafe __m256 _mm256_maskload_ps(ref float mem_addr, in __m256 mask)
            => MaskLoad(refptr(ref mem_addr), mask);
        
        ///<summary> void _mm256_maskstore_ps (float * mem_addr, __m256i mask, __m256 a) VMASKMOVPS __m256, ymm, ymm </summary> 
        [MethodImpl(Inline)]
        ...
        ///<summary> void _mm_maskstore_ps (float * mem_addr, __m128i mask, __m128 a) VMASKMOVPS __m128, xmm, xmm </summary> 
        [MethodImpl(Inline)]
        public static unsafe void _mm_maskstore_ps(ref float mem_addr, in __m128 mask, in __m128 a)
            => MaskStore(refptr(ref mem_addr), mask, a);
        
        ///<summary> void _mm_maskstore_pd (double * mem_addr, __m128i mask, __m128d a) VMASKMOVPD __m128, xmm, xmm </summary> 
        [MethodImpl(Inline)]
        public static unsafe void _mm_maskstore_pd(ref double mem_addr, in __m128d mask, in __m128d a)
            => MaskStore(refptr(ref mem_addr), mask, a);
        
        ///<summary> void _mm256_maskstore_pd (double * mem_addr, __m256i mask, __m256d a) VMASKMOVPD __m256, ymm, ymm </summary> 
        [MethodImpl(Inline)]
        ...
        ///<summary> void _mm256_store_si256 (__m256i * mem_addr, __m256i a) MOVDQA __m256, ymm </summary>
        [MethodImpl(Inline)]
        public static unsafe void _mm256_store_si256(ref ushort mem_addr, in __m256i a)
            => StoreAligned(refptr(ref mem_addr), a);
        
        ///<summary> void _mm256_store_si256 (__m256i * mem_addr, __m256i a) MOVDQA __m256, ymm </summary>
        [MethodImpl(Inline)]
        public static unsafe void _mm256_store_si256(ref ulong mem_addr, in __m256i a)
            => StoreAligned(refptr(ref mem_addr), a);
        
        ///<summary> void _mm256_store_si256 (__m256i * mem_addr, __m256i a) MOVDQA __m256, ymm </summary>
        [MethodImpl(Inline)]
        public static unsafe void _mm256_store_si256(ref uint mem_addr, in __m256i a)
            => StoreAligned(refptr(ref mem_addr), a);
        
        ///<summary> void _mm256_store_ps (float * mem_addr, __m256 a) VMOVAPS __m256, ymm </summary>
        [MethodImpl(Inline)]
        public static unsafe void _mm256_store_ps(ref float mem_addr, in __m256 a)
            => StoreAligned(refptr(ref mem_addr), a);
        
        ///<summary> void _mm256_store_pd (double * mem_addr, __m256d a) VMOVAPD __m256, ymm </summary>
        [MethodImpl(Inline)]
        public static unsafe void _mm256_store_pd(ref double mem_addr, in __m256d a)
            => StoreAligned(refptr(ref mem_addr), a);
        
        ///<summary> void _mm256_store_si256 (__m256i * mem_addr, __m256i a) MOVDQA __m256, ymm </summary>
        [MethodImpl(Inline)]
        public static unsafe void _mm256_store_si256(ref long mem_addr, in __m256i a)
            => StoreAligned(refptr(ref mem_addr), a);
                
        ///<summary> void _mm256_store_si256 (__m256i * mem_addr, __m256i a) MOVDQA __m256, ymm </summary>
        [MethodImpl(Inline)]
        public static unsafe void _mm256_store_si256(ref byte mem_addr, in __m256i a)
            => StoreAligned(refptr(ref mem_addr), a);
        
        ///<summary> void _mm256_store_si256 (__m256i * mem_addr, __m256i a) MOVDQA __m256, ymm </summary>
        [MethodImpl(Inline)]
        public static unsafe void _mm256_store_si256(ref sbyte mem_addr, in __m256i a)
            => StoreAligned(refptr(ref mem_addr), a);
        
        ///<summary> void _mm256_stream_si256 (__m256i * mem_addr, __m256i a) VMOVNTDQ __m256, ymm </summary>
        [MethodImpl(Inline)]
        public static unsafe void _mm256_stream_si256(ref ulong mem_addr, in __m256i a)
            => StoreAlignedNonTemporal(refptr(ref mem_addr), a);
        

        #if false
                                                                            
        ///<summary> __m256d _mm256_round_pd (__m256d a, _MM_FROUND_TO_NEAREST_INT | _MM_FROUND_NO_EXC) VROUNDPD ymm, ymm/m256, imm8(8)
        public static __m256d _mm256_round_pd(in __m256d a)
              => RoundToNearestInteger(a);
        
        ///<summary> __m256 _mm256_round_ps (__m256 a, _MM_FROUND_TO_NEAREST_INT | _MM_FROUND_NO_EXC) VROUNDPS ymm, ymm/m256, imm8(8)
        public static __m256 _mm256_round_ps(in __m256 a)
             => RoundToNearestInteger(a);
        
        ///<summary> __m256d _mm256_round_pd (__m256d a, _MM_FROUND_TO_NEG_INF | _MM_FROUND_NO_EXC) VROUNDPD ymm, ymm/m256, imm8(9)
        public static __m256d _mm256_round_pd(in __m256d a)
             => RoundToNegativeInfinity(a);
        
        ///<summary> __m256 _mm256_round_ps (__m256 a, _MM_FROUND_TO_NEG_INF | _MM_FROUND_NO_EXC) VROUNDPS ymm, ymm/m256, imm8(9)
        public static __m256 _mm256_round_ps(in __m256 a)
            => RoundToNegativeInfinity(a);

        //<summary> __m256d _mm256_round_pd (__m256d a, _MM_FROUND_TO_POS_INF | _MM_FROUND_NO_EXC) VROUNDPD ymm, ymm/m256, imm8(10)
        public static __m256d RoundToPositiveInfinity(in __m256d a)
            => throw new NotImplementedException();
        
        ///<summary> __m256 _mm256_round_ps (__m256 a, _MM_FROUND_TO_POS_INF | _MM_FROUND_NO_EXC) VROUNDPS ymm, ymm/m256, imm8(10)
        public static __m256 RoundToPositiveInfinity(in __m256 value)
            => RoundToPositiveInfinity(value);

        ///<summary> __m256 _mm256_round_ps (__m256 a, _MM_FROUND_TO_ZERO | _MM_FROUND_NO_EXC) VROUNDPS ymm, ymm/m256, imm8(11)
        public static __m256 RoundToZero(in __m256 value)
            => throw new NotImplementedException();
        
        ///<summary> __m256d _mm256_round_pd (__m256d a, _MM_FROUND_TO_ZERO | _MM_FROUND_NO_EXC) VROUNDPD ymm, ymm/m256, imm8(11)
        ...
        ///<summary> void _mm256_stream_ps (float * mem_addr, __m256 a) MOVNTPS __m256, ymm </summary>
        public static unsafe void StoreAlignedNonTemporal(ref float mem_addr, in __m256 a)        
            => throw new NotImplementedException();

        ///<summary> void _mm256_stream_pd (double * mem_addr, __m256d a) MOVNTPD __m256, ymm </summary>
