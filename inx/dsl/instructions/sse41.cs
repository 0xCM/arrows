...
/*
    ...
    public abstract class Sse41 : Ssse3
    {
        ...
        //
        // Summary:
        //     __m128d _mm_blend_pd (__m128d a, __m128d b, const int imm8) BLENDPD xmm, xmm/m128,
        //     imm8
        public static Vector128<double> Blend(Vector128<double> left, Vector128<double> right, byte control);
        //
        // Summary:
        //     __m128i _mm_blend_epi16 (__m128i a, __m128i b, const int imm8) PBLENDW xmm, xmm/m128
        //     imm8
        public static Vector128<short> Blend(Vector128<short> left, Vector128<short> right, byte control);
        //
        // Summary:
        //     __m128 _mm_blend_ps (__m128 a, __m128 b, const int imm8) BLENDPS xmm, xmm/m128,
        //     imm8
        ...
        //
        // Summary:
        //     __m128d _mm_blendv_pd (__m128d a, __m128d b, __m128d mask) BLENDVPD xmm, xmm/m128,
        //     xmm0
        ...
        //
        // Summary:
        //     __m128 _mm_blendv_ps (__m128 a, __m128 b, __m128 mask) BLENDVPS xmm, xmm/m128,
        //     xmm0
        ...
        //
        // Summary:
        //     __m128d _mm_dp_pd (__m128d a, __m128d b, const int imm8) DPPD xmm, xmm/m128,
        //     imm8
        ...
        //
        // Summary:
        //     __m128i _mm_insert_epi8 (__m128i a, int i, const int imm8) PINSRB xmm, reg/m8,
        //     imm8
        public static Vector128<byte> Insert(Vector128<byte> value, byte data, byte index);
        //
        // Summary:
        //     __m128i _mm_insert_epi32 (__m128i a, int i, const int imm8) PINSRD xmm, reg/m32,
        //     imm8
        ...
        //
        // Summary:
        //     __m128 _mm_insert_ps (__m128 a, __m128 b, const int imm8) INSERTPS xmm, xmm/m32,
        //     imm8
        ...
        //
        // Summary:
        //     __m128i _mm_mpsadbw_epu8 (__m128i a, __m128i b, const int imm8) MPSADBW xmm,
        //     xmm/m128, imm8
        ...
        //
        // Summary:
        //     __m128 _mm_round_ss (__m128 a, __m128 b, _MM_FROUND_CUR_DIRECTION) ROUNDSS xmm,
        //     xmm/m128, imm8(4)
        ...
        public abstract class X64 : Sse2.X64
        {
            ...
            //
            // Summary:
            //     __m128i _mm_insert_epi64 (__m128i a, __int64 i, const int imm8) PINSRQ xmm, reg/m64,
            //     imm8 This intrinisc is only available on 64-bit processes
