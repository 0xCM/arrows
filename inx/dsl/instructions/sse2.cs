...
/*
    ...
    public abstract class Sse2 : Sse
    {
        ...
        //
        // Summary:
        //     __m128i _mm_insert_epi16 (__m128i a, int i, int immediate) PINSRW xmm, reg/m16,
        //     imm8
        ...
        public static Vector128<double> LoadAlignedVector128(double* address);
        //
        // Summary:
        //     __m128i _mm_load_si128 (__m128i const* mem_address) MOVDQA xmm, m128
        ...
        public static Vector128<double> LoadHigh(Vector128<double> lower, double* address);
        //
        // Summary:
        //     __m128d _mm_loadl_pd (__m128d a, double const* mem_addr) MOVLPD xmm, m64
        public static Vector128<double> LoadLow(Vector128<double> upper, double* address);
        //
        // Summary:
        ...
        //
        // Summary:
        //     __m128i _mm_loadl_epi32 (__m128i const* mem_addr) MOVD xmm, reg/m32 The above
        //     native signature does not exist. We provide this additional overload for completeness.
        ...
        //
        // Summary:
        //     void _mm_maskmoveu_si128 (__m128i a, __m128i mask, char* mem_address) MASKMOVDQU
        //     xmm, xmm
        ...
        //
        // Summary:
        //     __m128d _mm_shuffle_pd (__m128d a, __m128d b, int immediate) SHUFPD xmm, xmm/m128,
        //     imm8
        ...
        //
        // Summary:
        //     __m128i _mm_shufflehi_epi16 (__m128i a, int immediate) PSHUFHW xmm, xmm/m128,
        //     imm8
        ...
        //
        // Summary:
        //     __m128d _mm_sqrt_sd (__m128d a) SQRTSD xmm, xmm/64 The above native signature
        //     does not exist. We provide this additional overload for the recommended use case
        //     of this intrinsic.
        ...
        public static void StoreAligned(double* address, Vector128<double> source);
        //
        // Summary:
        //     void _mm_store_si128 (__m128i* mem_addr, __m128i a) MOVDQA m128, xmm
        ...
        public static void StoreAlignedNonTemporal(double* address, Vector128<double> source);
        //
        // Summary:
        //     void _mm_stream_si128 (__m128i* mem_addr, __m128i a) MOVNTDQ m128, xmm
        ...
        public static void StoreHigh(double* address, Vector128<double> source);
        //
        // Summary:
        //     void _mm_storel_pd (double* mem_addr, __m128d a) MOVLPD m64, xmm
        public static void StoreLow(double* address, Vector128<double> source);
        //
        // Summary:
        ...
        public static void StoreScalar(double* address, Vector128<double> source);
        ...
        public abstract class X64 : Sse.X64
        {
            ...
            //
            // Summary:
            //     __m128d _mm_cvtsi64_sd (__m128d a, __int64 b) CVTSI2SD xmm, reg/m64 This intrinisc
            //     is only available on 64-bit processes
            public static Vector128<double> ConvertScalarToVector128Double(Vector128<double> upper, long value);
            //
            // Summary:
            //     __m128i _mm_cvtsi64_si128 (__int64 a) MOVQ xmm, reg/m64 This intrinisc is only
            //     available on 64-bit processes
            ...
            //
            // Summary:
            //     __int64 _mm_cvtsd_si64 (__m128d a) CVTSD2SI r64, xmm/m64 This intrinisc is only
            //     available on 64-bit processes
            public static long ConvertToInt64(Vector128<double> value);
            //
            // Summary:
            //     __int64 _mm_cvtsi128_si64 (__m128i a) MOVQ reg/m64, xmm This intrinisc is only
            //     available on 64-bit processes
            public static long ConvertToInt64(Vector128<long> value);
            //
            // Summary:
            //     __int64 _mm_cvttsd_si64 (__m128d a) CVTTSD2SI reg, xmm/m64 This intrinisc is
            //     only available on 64-bit processes
            ...
            //
            // Summary:
            //     void _mm_stream_si64(__int64 *p, __int64 a) MOVNTI m64, r64 This intrinisc is
            //     only available on 64-bit processes
