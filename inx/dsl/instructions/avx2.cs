...
namespace Z0
{
    ...
    partial class x86
    {
        ...
        ///<intrinsic> __m256i _mm256_abs_epi8 (__m256i a) VPABSB ymm, ymm/m256
        [MethodImpl(Inline)]
        public static __m256i _mm256_abs_epi8(in __m256i a)
            => Abs(v8i(a));

        ///<intrinsic> __m256i _mm256_abs_epi16 (__m256i a) VPABSW ymm, ymm/m256
        [MethodImpl(Inline)]
        public static __m256i _mm256_abs_epi16(in __m256i a)
            => Abs(v16i(a));

        ///<intrinsic> __m256i _mm256_abs_epi32 (__m256i a) VPABSD ymm, ymm/m256
        [MethodImpl(Inline)]
        public static __m256i _mm256_abs_epi32(in __m256i a)
            => Abs(v32i(a));

        ///<intrinsic> __m256i _mm256_subs_epu16 (__m256i a, __m256i b) VPSUBUSW ymm, ymm, ymm/m256
        [MethodImpl(Inline)]
        public static __m256i _mm256_subs_epu16(in __m256i a, in __m256i b)
            => SubtractSaturate(v16i(a), v16i(b));

        ///<intrinsic> __m256i _mm256_sad_epu8 (__m256i a, __m256i b) VPSADBW ymm, ymm, ymm/m256
        [MethodImpl(Inline)]
        public static __m256i _mm256_sad_epu8(in __m256i a, in __m256i b)
            => SumAbsoluteDifferences(a, b);

        ///<intrinsic> __m256i _mm256_unpackhi_epi64 (__m256i a, __m256i b) VPUNPCKHQDQ ymm, ymm, ymm/m256
        [MethodImpl(Inline)]
        public static __m256i _mm256_unpackhi_epi64(in __m256i a, in __m256i b)
            => UnpackHigh(v64i(a), v64i(b));

        //<intrinsic> __m256i _mm256_add_epi64 (__m256i a, __m256i b) VPADDQ ymm, ymm, ymm/m256
        [MethodImpl(Inline)]
        public static __m256i _mm256_add_epi64(in __m256i a, in __m256i b)
            => Add(v64i(a), v64i(b));

        //<intrinsic> __m256i _mm256_add_epi32 (__m256i a, __m256i b) VPADDD ymm, ymm, ymm/m256
        [MethodImpl(Inline)]
        public static __m256i _mm256_add_epi32(in __m256i a, in __m256i b)
            => Add(v32i(a), v32i(b));

        //<intrinsic> __m256i _mm256_add_epi16 (__m256i a, __m256i b) VPADDW ymm, ymm, ymm/m256
        [MethodImpl(Inline)]
        public static __m256i _mm256_add_epi16(in __m256i a, in __m256i b)
            => Add(v16i(a), v16i(b));

        //<intrinsic> __m256i _mm256_add_epi8 (__m256i a, __m256i b) VPADDB ymm, ymm, ymm/m256
        [MethodImpl(Inline)]
        public static __m256i _mm256_add_epi8(in __m256i a, in __m256i b)
            => Add(v8i(a), v8i(b));

        ///<intrinsic> __m256i _mm256_adds_epu8 (__m256i a, __m256i b) VPADDUSB ymm, ymm, ymm/m256
        [MethodImpl(Inline)]
        ...
        //<intrinsic> __m256i _mm256_unpacklo_epi64 (__m256i a, __m256i b) VPUNPCKLQDQ ymm, ymm, ymm/m256
        [MethodImpl(Inline)]
        ...
        [MethodImpl(Inline)]
        public static unsafe __m256i _mm256_cvtepi8_epi64(ref byte address)
            => ConvertToVector256Int64(refptr(ref address));        


        [MethodImpl(Inline)]
        public static unsafe __m256i _mm256_cvtepi32_epi64(ref int address)
            => ConvertToVector256Int64(refptr(ref address));      

        [MethodImpl(Inline)]
        public static unsafe __m256i _mm256_cvtepi16_epi64(ref short address)
            => ConvertToVector256Int64(refptr(ref address));        
        ...
        ///<intrinsic> __m256i _mm256_srli_epi32 (__m256i a, int imm8) VPSRLD ymm, ymm, imm8
        [MethodImpl(Inline)]
        public static __m256i _mm256_srli_epi32(in __m256i a, byte imm8)
            => ShiftRightLogical(v32i(a), imm8);

        ///<intrinsic> __m256i _mm256_srl_epi64 (__m256i a, __m128i imm8) VPSRLQ ymm, ymm, xmm/m128
        [MethodImpl(Inline)]
        public static __m256i _mm256_srl_epi64(in __m256i a, in __m128i imm8)
            => ShiftRightLogical(v64i(a), imm8);

        ///<intrinsic> __m256i _mm256_srl_epi32 (__m256i a, __m128i imm8) VPSRLD ymm, ymm, xmm/m128
        [MethodImpl(Inline)]
        public static __m256i _mm256_srl_epi32(in __m256i a, in __m128i imm8)
            => ShiftRightLogical(v32i(a), imm8);

        ///<intrinsic> __m256i _mm256_srl_epi16 (__m256i a, __m128i imm8) VPSRLW ymm, ymm, xmm/m128
        [MethodImpl(Inline)]
        public static __m256i _mm256_srl_epi16(in __m256i a, Vector128<ushort> imm8)
            => ShiftRightLogical(a, imm8);

        ///<intrinsic> __m256i _mm256_srli_epi16 (__m256i a, int imm8) VPSRLW ymm, ymm, imm8
        [MethodImpl(Inline)]
        ...
        ///<intrinsic> __m256i _mm256_srl_epi16 (__m256i a, __m128i imm8) VPSRLW ymm, ymm, xmm/m128
        [MethodImpl(Inline)]
        public static __m256i _mm256_srl_epi16(in __m256i a, in __m128i imm8)
            => ShiftRightLogical(v16i(a), imm8);

        //<intrinsic> __m256i _mm256_slli_epi32 (__m256i a, int imm8) VPSLLD ymm, ymm, imm8
        public static __m256i _mm256_slli_epi32(in __m256i a, byte imm8)
            => ShiftLeftLogical(v32i(a),imm8);

        ///<intrinsic> __m256i _mm256_andnot_si256 (__m256i a, __m256i b) VPANDN ymm, ymm, ymm/m256
        [MethodImpl(Inline)]
        public static __m256i _mm256_andnot_si256(in __m256i a, in __m256i b)
            => AndNot(v64i(a),v64i(b));

        ///<intrinsic> __m256i _mm256_avg_epu8 (__m256i a, __m256i b) VPAVGB ymm, ymm, ymm/m256
        [MethodImpl(Inline)]
        public static __m256i _mm256_avg_epu8(in __m256i a, in __m256i b)
            => Average(v8u(a), v8u(b));

        ///<intrinsic> __m256i _mm256_unpacklo_epi8 (__m256i a, __m256i b) VPUNPCKLBW ymm, ymm, ymm/m256
        [MethodImpl(Inline)]
        public static __m256i _mm256_unpacklo_epi8(in __m256i a, in __m256i b)
            => UnpackLow(v8i(a), v8i(b));

        ///<intrinsic> __m256i _mm256_unpacklo_epi32 (__m256i a, __m256i b) VPUNPCKLDQ ymm, ymm, ymm/m256
        [MethodImpl(Inline)]
        public static __m256i _mm256_unpacklo_epi32(in __m256i a, in __m256i b)
            => UnpackLow(v32i(a), v32i(b));


        ///<intrinsic> __m256i _mm256_unpacklo_epi16 (__m256i a, __m256i b) VPUNPCKLWD ymm, ymm, ymm/m256
        [MethodImpl(Inline)]
        public static __m256i _mm256_unpacklo_epi16(in __m256i a, in __m256i b)
            => UnpackLow(v16i(a), v16i(b));

        ///<intrinsic> __m128i _mm_blend_epi32 (__m128i a, __m128i b, const int imm8) VPBLENDD xmm, xmm, xmm/m128, imm8
        [MethodImpl(Inline)]
        public static __m128i _mm_blend_epi32(in __m128i left, in __m128i right, byte imm8)
            => Blend(v32i(left), v32i(right), imm8);

        ///<intrinsic> __m256i _mm256_blend_epi16 (__m256i a, __m256i b, const int imm8) VPBLENDW ymm, ymm, ymm/m256, imm8
        [MethodImpl(Inline)]
        public static __m256i _mm256_blend_epi16(in __m256i a, in __m256i b, byte imm8)
            => Blend(v16i(a),v16i(b), imm8);

        //<intrinsic> __m256i _mm256_blend_epi32 (__m256i a, __m256i b, const int imm8) VPBLENDD ymm, ymm, ymm/m256, imm8
        [MethodImpl(Inline)]
        ...
        ///<intrinsic> __m256i _mm256_maddubs_epi16 (__m256i a, __m256i b) VPMADDUBSW ymm, ymm, ymm/m256
        [MethodImpl(Inline)]
        public static __m256i _mm256_maddubs_epi16(in __m256i a, in __m256i b)
            => MultiplyAddAdjacent(v8u(a),v8i(b));

        ///<intrinsic> __m256i _mm256_madd_epi16 (__m256i a, __m256i b) VPMADDWD ymm, ymm, ymm/m256
        [MethodImpl(Inline)]
        public static __m256i _mm256_madd_epi16(in __m256i a, in __m256i b)
            => MultiplyAddAdjacent(v16i(a),v16i(b));

        ///<intrinsic> __m256i _mm256_avg_epu16 (__m256i a, __m256i b) VPAVGW ymm, ymm, ymm/m256
        [MethodImpl(Inline)]
        public static __m256i _mm256_avg_epu16(in __m256i a, in __m256i b)
            => Average(v16u(a),v16u(b));

        //<intrinsic> __m256i _mm256_broadcastsi128_si256 (__m128i a) VBROADCASTI128 ymm, in __m128 
        [MethodImpl(Inline)]
        public static unsafe __m256i _mm256_broadcastsi128_si256(ref ulong address)
            => BroadcastVector128ToVector256(refptr(ref address));

        //<intrinsic> __m256i _mm256_broadcastsi128_si256 (__m128i a) VBROADCASTI128 ymm, in __m128 The        
        [MethodImpl(Inline)]
        public static unsafe __m256i _mm256_broadcastsi128_si256(ref short address)
            => BroadcastVector128ToVector256(refptr(ref address));


        //<intrinsic> __m256i _mm256_mulhi_epi16 (__m256i a, __m256i b) VPMULHW ymm, ymm, ymm/m256
        public static __m256i _mm256_mulhi_epi16(in __m256i a, in __m256i b)
            => MultiplyHigh(v16i(a),v16i(b));

        //<intrinsic> __m256i _mm256_mulhi_epu16 (__m256i a, __m256i b) VPMULHUW ymm, ymm, ymm/m256
        public static __m256i _mm256_mulhi_epu16(in __m256i a, in __m256i b)
            => MultiplyHigh(v16u(a),v16u(b));

        //<intrinsic> __m256i _mm256_mullo_epi16 (__m256i a, __m256i b) VPMULLW ymm, ymm, ymm/m256
        public static __m256i _mm256_mullo_epi16(in __m256i a, in __m256i b)
            => MultiplyLow(v16i(a),v16i(b));

        //<intrinsic> __m256i _mm256_mullo_epi32 (__m256i a, __m256i b) VPMULLD ymm, ymm, ymm/m256
        ...
        public static __m128i _mm_broadcastq_epi64(ref ulong source);
        //
        ...
        public static __m128i _mm_broadcastd_epi32(ref uint source);
        //
        ...
        public static __m128i _mm_broadcastb_epi8(ref sbyte source);
        ...
        public static __m128i _mm_broadcastw_epi16(ref short source);
        public static __m128i _mm_broadcastb_epi8(in __m128i value);

        //<intrinsic> __m128i _mm_broadcastd_epi32 (__m128i a) VPBROADCASTD xmm, in m32        
        public static __m128i _mm_broadcastd_epi32(ref int source);
        //

        //<intrinsic> __m128i _mm_broadcastq_epi64 (__m128i a) VPBROADCASTQ xmm, in m64
        
        public static __m128i _mm_broadcastq_epi64(ref long source);
        //

        //<intrinsic> __m128i _mm_broadcastb_epi8 (__m128i a) VPBROADCASTB xmm, in m8
        
        public static __m128i _mm_broadcastb_epi8(ref byte source);
        //
        ...
        public static __m256i _mm256_broadcastq_epi64(ref ulong source);
        //

        //<intrinsic> __m256i _mm256_broadcastd_epi32 (__m128i a) VPBROADCASTD ymm, in m32
        
        public static __m256i _mm256_broadcastd_epi32(ref uint source)
            => BroadcastScalarToVector256(ref src);
        //

        //<intrinsic> __m256i _mm256_broadcastw_epi16 (__m128i a) VPBROADCASTW ymm, in m16
        
        public static __m256i _mm256_broadcastw_epi16(ref ushort source)
            => BroadcastScalarToVector256(ref src);
        //

        //<intrinsic> __m256i _mm256_broadcastb_epi8 (__m128i a) VPBROADCASTB ymm, in m8
        
        public static __m256i _mm256_broadcastb_epi8(ref sbyte source)
            => BroadcastScalarToVector256(ref src);
        //

        //<intrinsic> __m256i _mm256_broadcastd_epi32 (__m128i a) VPBROADCASTD ymm, xmm
        public static __m256i _mm256_broadcastd_epi32(in __m128i value)
            => BroadcastScalarToVector256(ref src);
        //

        //<intrinsic> __m256i _mm256_broadcastw_epi16 (__m128i a) VPBROADCASTW ymm, xmm
        public static __m256i _mm256_broadcastw_epi16(Vector128<ushort> value)
            => BroadcastScalarToVector256(ref src);

        //

        //<intrinsic> __m256i _mm256_broadcastb_epi8 (__m128i a) VPBROADCASTB ymm, xmm
        public static __m256i _mm256_broadcastb_epi8(in __m128i value)
            => BroadcastScalarToVector256(ref src);

        //

        //<intrinsic> __m256i _mm256_broadcastq_epi64 (__m128i a) VPBROADCASTQ ymm, xmm
        public static __m256i _mm256_broadcastq_epi64(in __m128i value)
            => BroadcastScalarToVector256(ref src);
        ...
        public static __m256i _mm256_broadcastb_epi8(ref byte source)
            => BroadcastScalarToVector256(ref src);
        ...
        public static __m256i _mm256_broadcastw_epi16(ref short source)
            => BroadcastScalarToVector256(ref src);
        ...
        public static __m256i _mm256_broadcastd_epi32(ref int source)
            => BroadcastScalarToVector256(ref src);

        //

        //<intrinsic> __m256 _mm256_broadcastss_ps (__m128 a) VBROADCASTSS ymm, xmm
        public static m256 _mm256_broadcastss_ps(in __m128d value)
            => BroadcastScalarToVector256(ref src);
        ...
        public static m256d _mm256_broadcastsd_pd(in __m128d value);
        //

        //<intrinsic> __m256i _mm256_broadcastw_epi16 (__m128i a) VPBROADCASTW ymm, xmm
        public static __m256i _mm256_broadcastw_epi16(in __m128i value);

        //<intrinsic> __m256i _mm256_broadcastq_epi64 (__m128i a) VPBROADCASTQ ymm, in m64        
        public static __m256i BroadcastScalarToVector256(ref long source);
        //

        //<intrinsic> __m256i _mm256_broadcastsi128_si256 (__m128i a) VBROADCASTI128 ymm, in __m128 The        
        public static __m256i BroadcastVector128ToVector256(ref byte address);
        //

        //<intrinsic> __m256i _mm256_broadcastsi128_si256 (__m128i a) VBROADCASTI128 ymm, in __m128 The
        
        public static __m256i BroadcastVector128ToVector256(ref int address);
        //

        //<intrinsic> __m256i _mm256_broadcastsi128_si256 (__m128i a) VBROADCASTI128 ymm, in __m128 The
        
        public static __m256i BroadcastVector128ToVector256(ref long address);
        //

        //<intrinsic> __m256i _mm256_broadcastsi128_si256 (__m128i a) VBROADCASTI128 ymm, in __m128 The
        
        public static __m256i BroadcastVector128ToVector256(ref sbyte address);
        //

        //<intrinsic> __m256i _mm256_broadcastsi128_si256 (__m128i a) VBROADCASTI128 ymm, in __m128 The
        
        public static __m256i BroadcastVector128ToVector256(ref ushort address);
        //

        //<intrinsic> __m256i _mm256_broadcastsi128_si256 (__m128i a) VBROADCASTI128 ymm, in __m128 The
        
        public static __m256i BroadcastVector128ToVector256(ref uint address);
        //
        ...
        public static __m256i ConvertToVector256Int16(in __m128i value);
        //
        ...
        public static __m256i _mm256_cvtepi8_epi16(ref sbyte address);
        public static __m256i _mm256_cvtepi16_epi32(ref ushort address);
        public static __m256i _mm256_cvtepi8_epi32(ref sbyte address);
        public static __m256i _mm256_cvtepi16_epi32(Vector128<ushort> value);
        public static __m256i _mm256_cvtepi16_epi32(ref short address);
        //
        ...
        public static __m256i _mm256_cvtepi8_epi32(ref byte address);
        //

        //<intrinsic> __m256i _mm256_cvtepi8_epi32 (__m128i a) VPMOVSXBD ymm, xmm/m128
        public static __m256i ConvertToVector256Int64(ref uint address);
        public static __m256i _mm256_cvtepi8_epi32(in __m128i value);
        public static __m256i _mm256_cvtepi16_epi64(ref ushort address);
        public static __m256i _mm256_cvtepi8_epi64(ref sbyte address);
        public static __m256i _mm256_cvtepi16_epi64(Vector128<ushort> value);
        //
        ...
        //<intrinsic> __m128i _mm256_extracti128_si256 (__m256i a, const int imm8) VEXTRACTI128 xmm,
        //     ymm, imm8
        public static Vector128<ushort> ExtractVector128(in __m256i a, byte index);
        //
        ...
        public static __m128i GatherMaskVector128(in __m128i source, ref ulong base_addr, in __m128i index, in __m128i mask, byte scale);
        //
        ...
        //     should be 1, 2, 4 or 8, otherwise, ArgumentOutOfRangeException will be thrown.
        public static __m128i GatherMaskVector128(in __m128i source, ref uint base_addr, in __m256i index, in __m128i mask, byte scale);
        //
        ...
        //     should be 1, 2, 4 or 8, otherwise, ArgumentOutOfRangeException will be thrown.
        public static __m128i GatherMaskVector128(in __m128i source, ref uint base_addr, in __m128i index, in __m128i mask, byte scale);
        //
        ...
        //     should be 1, 2, 4 or 8, otherwise, ArgumentOutOfRangeException will be thrown.
        public static __m128d GatherMaskVector128(in __m128d source, ref float base_addr, in __m256i index, in __m128d mask, byte scale);
        //
        ...
        //     should be 1, 2, 4 or 8, otherwise, ArgumentOutOfRangeException will be thrown.
        public static __m128d GatherMaskVector128(in __m128d source, ref float base_addr, in __m128i index, in __m128d mask, byte scale);
        //

        //<intrinsic> __m128i _mm_mask_i64gather_epi64 (__m128i src, __int64 const* base_addr, __m128i
        //     vindex, __m128i mask, const int scale) VPGATHERQQ xmm, vm64x, xmm The scale parameter
        //     should be 1, 2, 4 or 8, otherwise, ArgumentOutOfRangeException will be thrown.
        public static __m128i GatherMaskVector128(in __m128i source, ref long base_addr, in __m128i index, in __m128i mask, byte scale);
        //
        ...
        //     vindex, __m128i mask, const int scale) VPGATHERQD xmm, vm32y, xmm The scale parameter
        //     should be 1, 2, 4 or 8, otherwise, ArgumentOutOfRangeException will be thrown.
        public static __m128i GatherMaskVector128(in __m128i source, ref int base_addr, in __m256i index, in __m128i mask, byte scale);
        //

        //<intrinsic> __m128i _mm_mask_i64gather_epi32 (__m128i src, int const* base_addr, __m128i
        //     vindex, __m128i mask, const int scale) VPGATHERQD xmm, vm64x, xmm The scale parameter
        //     should be 1, 2, 4 or 8, otherwise, ArgumentOutOfRangeException will be thrown.
        public static __m128i GatherMaskVector128(in __m128i source, ref int base_addr, in __m128i index, in __m128i mask, byte scale);
        //
        ...
        //     should be 1, 2, 4 or 8, otherwise, ArgumentOutOfRangeException will be thrown.
        public static __m128d GatherMaskVector128(in __m128d source, ref double base_addr, in __m128i index, in __m128d mask, byte scale);
        //
        ...
        //     should be 1, 2, 4 or 8, otherwise, ArgumentOutOfRangeException will be thrown.
        public static __m256i GatherMaskVector256(in __m256i source, ref ulong base_addr, in __m256i index, in __m256i mask, byte scale);
        //
        ...
        //     should be 1, 2, 4 or 8, otherwise, ArgumentOutOfRangeException will be thrown.
        public static __m256i GatherMaskVector256(in __m256i source, ref ulong base_addr, in __m128i index, in __m256i mask, byte scale);
        //
        ...
        //     should be 1, 2, 4 or 8, otherwise, ArgumentOutOfRangeException will be thrown.
        public static __m256i GatherMaskVector256(in __m256i source, ref uint base_addr, in __m256i index, in __m256i mask, byte scale);
        //
        ...
        //     should be 1, 2, 4 or 8, otherwise, ArgumentOutOfRangeException will be thrown.
        public static m256 GatherMaskVector256(in m256 source, ref float base_addr, in __m256i index, in m256 mask, byte scale);
        //

        //<intrinsic> __m256i _mm256_mask_i32gather_epi64 (__m256i src, __int64 const* base_addr, __m128i
        //     vindex, __m256i mask, const int scale) VPGATHERDQ ymm, vm32y, ymm The scale parameter
        //     should be 1, 2, 4 or 8, otherwise, ArgumentOutOfRangeException will be thrown.
        public static __m256i GatherMaskVector256(in __m256i source, ref long base_addr, in __m128i index, in __m256i mask, byte scale);
        //

        //<intrinsic> __m256i _mm256_mask_i32gather_epi32 (__m256i src, int const* base_addr, __m256i
        //     vindex, __m256i mask, const int scale) VPGATHERDD ymm, vm32y, ymm The scale parameter
        //     should be 1, 2, 4 or 8, otherwise, ArgumentOutOfRangeException will be thrown.
        public static __m256i GatherMaskVector256(in __m256i source, ref int base_addr, in __m256i index, in __m256i mask, byte scale);
        //
        ...
        //     should be 1, 2, 4 or 8, otherwise, ArgumentOutOfRangeException will be thrown.
        public static m256d GatherMaskVector256(in m256d source, ref double base_addr, in __m256i index, in m256d mask, byte scale);
        //
        ...
        //<intrinsic> __m256i _mm256_inserti128_si256 (__m256i a, __m128i b, const int imm8) VINSERTI128
        //     ymm, ymm, xmm, imm8
        public static __m256i InsertVector128(in __m256i a, Vector128<ushort> data, byte index);
        //
        ...
        public static __m256i _mm256_stream_load_si256(ref ulong address);
        //

        //<intrinsic> __m256i _mm256_stream_load_si256 (__m256i const* mem_addr) VMOVNTDQA ymm, in m256
        public static __m256i _mm256_stream_load_si256(ref ushort address);
        //

        //<intrinsic> __m256i _mm256_stream_load_si256 (__m256i const* mem_addr) VMOVNTDQA ymm, in m256
        public static __m256i _mm256_stream_load_si256(ref sbyte address);
        //

        //<intrinsic> __m256i _mm256_stream_load_si256 (__m256i const* mem_addr) VMOVNTDQA ymm, in m256
        public static __m256i LoadAlignedVector256NonTemporal(ref uint address);
        //

        //<intrinsic> __m256i _mm256_stream_load_si256 (__m256i const* mem_addr) VMOVNTDQA ymm, in m256
        public static __m256i LoadAlignedVector256NonTemporal(ref int address);
        //

        //<intrinsic> __m256i _mm256_stream_load_si256 (__m256i const* mem_addr) VMOVNTDQA ymm, in m256
        public static __m256i LoadAlignedVector256NonTemporal(ref short address);
        //

        //<intrinsic> __m256i _mm256_stream_load_si256 (__m256i const* mem_addr) VMOVNTDQA ymm, in m256
        public static __m256i LoadAlignedVector256NonTemporal(ref byte address);
        //

        //<intrinsic> __m256i _mm256_stream_load_si256 (__m256i const* mem_addr) VMOVNTDQA ymm, in m256
        public static __m256i LoadAlignedVector256NonTemporal(ref long address);
        //

        //<intrinsic> __m128i _mm_maskload_epi32 (int const* mem_addr, __m128i mask) VPMASKMOVD xmm,
        //     xmm, in __m128
        public static __m128i MaskLoad(ref int address, in __m128i mask);
        //

        //<intrinsic> __m256i _mm256_maskload_epi32 (int const* mem_addr, __m256i mask) VPMASKMOVD ymm, ymm, in m256
        public static __m256i MaskLoad(ref int address, in __m256i mask);

        //<intrinsic> __m128i _mm_maskload_epi64 (__int64 const* mem_addr, __m128i mask) VPMASKMOVQ xmm, xmm, in __m128
        public static __m128i MaskLoad(ref long address, in __m128i mask);

        //<intrinsic> __m256i _mm256_maskload_epi64 (__int64 const* mem_addr, __m256i mask) VPMASKMOVQ ymm, ymm, in m256
        public static __m256i MaskLoad(ref long address, in __m256i mask);

        //<intrinsic> __m128i _mm_maskload_epi32 (int const* mem_addr, __m128i mask) VPMASKMOVD xmm, xmm, in __m128
        public static __m128i MaskLoad(ref uint address, in __m128i mask);

        //<intrinsic> __m256i _mm256_maskload_epi32 (int const* mem_addr, __m256i mask) VPMASKMOVD
        //     ymm, ymm, in m256
        public static __m256i MaskLoad(ref uint address, in __m256i mask);
        //

        //<intrinsic> __m128i _mm_maskload_epi64 (__int64 const* mem_addr, __m128i mask) VPMASKMOVQ
        //     xmm, xmm, in __m128
        public static __m128i MaskLoad(ref ulong address, in __m128i mask);
        //

        //<intrinsic> __m256i _mm256_maskload_epi64 (__int64 const* mem_addr, __m256i mask) VPMASKMOVQ
        //     ymm, ymm, in m256
        public static __m256i MaskLoad(ref ulong address, in __m256i mask);
        //

        //     void _mm_maskstore_epi64 (__int64* mem_addr, __m128i mask, __m128i a) VPMASKMOVQ
        //     __m128, xmm, xmm
        public static void MaskStore(ref ulong address, in __m128i mask, in __m128i source);
        //

        //     void _mm256_maskstore_epi64 (__int64* mem_addr, __m256i mask, __m256i a) VPMASKMOVQ
        //     m256, ymm, ymm
        public static void MaskStore(ref ulong address, in __m256i mask, in __m256i source);
        //

        //     void _mm256_maskstore_epi32 (ref int mem_addr, __m256i mask, __m256i a) VPMASKMOVD
        //     m256, ymm, ymm
        public static void MaskStore(ref uint address, in __m256i mask, in __m256i source);
        //

        //     void _mm256_maskstore_epi32 (ref int mem_addr, __m256i mask, __m256i a) VPMASKMOVD
        //     m256, ymm, ymm
        public static void MaskStore(ref int address, in __m256i mask, in __m256i source);
        //

        //     void _mm256_maskstore_epi64 (__int64* mem_addr, __m256i mask, __m256i a) VPMASKMOVQ
        //     m256, ymm, ymm
        public static void MaskStore(ref long address, in __m256i mask, in __m256i source);
        //

        //     void _mm_maskstore_epi32 (ref int mem_addr, __m128i mask, __m128i a) VPMASKMOVD
        //     __m128, xmm, xmm
        public static void MaskStore(ref uint address, in __m128i mask, in __m128i source);
        //

        //     void _mm_maskstore_epi32 (ref int mem_addr, __m128i mask, __m128i a) VPMASKMOVD
        //     __m128, xmm, xmm
        public static void MaskStore(ref int address, in __m128i mask, in __m128i source);
        //

        //     void _mm_maskstore_epi64 (__int64* mem_addr, __m128i mask, __m128i a) VPMASKMOVQ
        //     __m128, xmm, xmm
        public static void MaskStore(ref long address, in __m128i mask, in __m128i source);
        //
        ...
        //<intrinsic> __m256i _mm256_sll_epi32 (__m256i a, __m128i count) VPSLLD ymm, ymm, xmm/m128
        public static __m256i ShiftLeftLogical(in __m256i a, in __m128i count);
        //

        //

        //<intrinsic> __m256i _mm256_sll_epi16 (__m256i a, __m128i count) VPSLLW ymm, ymm, xmm/m128
        public static __m256i ShiftLeftLogical(in __m256i a, Vector128<ushort> count);
        //
        ...
        //<intrinsic> __m256i _mm256_slli_epi64 (__m256i a, int imm8) VPSLLQ ymm, ymm, imm8
        ...
        //<intrinsic> __m256i _mm256_slli_epi16 (__m256i a, int imm8) VPSLLW ymm, ymm, imm8
        public static __m256i ShiftLeftLogical(in __m256i a, byte count);
        //
        ...
        //<intrinsic> __m256i _mm256_bslli_epi128 (__m256i a, const int imm8) VPSLLDQ ymm, ymm, imm8
        ...
        //<intrinsic> __m256i _mm256_sllv_epi64 (__m256i a, __m256i imm8) VPSLLVQ ymm, ymm, ymm/m256
        ...
        //<intrinsic> __m256i _mm256_sllv_epi64 (__m256i a, __m256i count) VPSLLVQ ymm, ymm, ymm/m256
        public static __m256i ShiftLeftLogicalVariable(in __m256i a, in __m256i count);
        //

        //<intrinsic> __m128i _mm_sllv_epi32 (__m128i a, __m128i count) VPSLLVD xmm, ymm, xmm/m128
        ...
        //<intrinsic> __m256i _mm256_sign_epi16 (__m256i a, __m256i b) VPSIGNW ymm, ymm, ymm/m256
        public static __m256i Sign(in __m256i a, in __m256i b);
        //

        //<intrinsic> __m256i _mm256_sign_epi32 (__m256i a, __m256i b) VPSIGND ymm, ymm, ymm/m256
        public static __m256i Sign(in __m256i a, in __m256i b);
        //

        //<intrinsic> __m256i _mm256_sign_epi8 (__m256i a, __m256i b) VPSIGNB ymm, ymm, ymm/m256
        public static __m256i Sign(in __m256i a, in __m256i b);
        //

        //<intrinsic> __m256i _mm256_sub_epi64 (__m256i a, __m256i b) VPSUBQ ymm, ymm, ymm/m256
        public static __m256i Subtract(in __m256i a, in __m256i b);
        //

        //<intrinsic> __m256i _mm256_sub_epi32 (__m256i a, __m256i b) VPSUBD ymm, ymm, ymm/m256
        public static __m256i Subtract(in __m256i a, in __m256i b);
        //

        //<intrinsic> __m256i _mm256_sub_epi16 (__m256i a, __m256i b) VPSUBW ymm, ymm, ymm/m256
        public static __m256i Subtract(in __m256i a, in __m256i b);
        //

        //<intrinsic> __m256i _mm256_sub_epi8 (__m256i a, __m256i b) VPSUBB ymm, ymm, ymm/m256
        ...
        //<intrinsic> __m256i _mm256_subs_epu8 (__m256i a, __m256i b) VPSUBUSB ymm, ymm, ymm/m256
        public static __m256i _mm256_subs_epu8(in __m256i a, in __m256i b);
        //

        //<intrinsic> __m256i _mm256_subs_epi16 (__m256i a, __m256i b) VPSUBSW ymm, ymm, ymm/m256
        public static __m256i _mm256_subs_epi16(in __m256i a, in __m256i b);
        //

        //<intrinsic> __m256i _mm256_subs_epi8 (__m256i a, __m256i b) VPSUBSB ymm, ymm, ymm/m256
        public static __m256i _mm256_subs_epi8(in __m256i a, in __m256i b);
        //

        //<intrinsic> __m256i _mm256_unpackhi_epi32 (__m256i a, __m256i b) VPUNPCKHDQ ymm, ymm, ymm/m256
        public static __m256i UnpackHigh(in __m256i a, in __m256i b);

        //<intrinsic> __m256i _mm256_unpackhi_epi16 (__m256i a, __m256i b) VPUNPCKHWD ymm, ymm, ymm/m256
        ...
        //<intrinsic> __m256i _mm256_unpackhi_epi8 (__m256i a, __m256i b) VPUNPCKHBW ymm, ymm, ymm/m256
        ...
        //<intrinsic> __m256i _mm256_xor_si256 (__m256i a, __m256i b) VPXOR ymm, ymm, ymm/m256
        public static __m256i _mm256_xor_si256(in __m256i a, in __m256i b);
