...
namespace Z0
{
    ...
    {
        [MethodImpl(Inline)]
        public static Vec128<sbyte> Flip(this in Vec128<sbyte> lhs)
            => flip(in lhs);

        [MethodImpl(Inline)]
        public static Vec128<byte> Flip(this in Vec128<byte> lhs)
            => flip(in lhs);

        [MethodImpl(Inline)]
        public static Vec128<short> Flip(this in Vec128<short> lhs)
            => flip(in lhs);

        [MethodImpl(Inline)]
        public static Vec128<ushort> Flip(this in Vec128<ushort> lhs)
            => flip(in lhs);

        [MethodImpl(Inline)]
        public static Vec128<int> Flip(this in Vec128<int> lhs)
            => flip(in lhs);

        [MethodImpl(Inline)]
        public static Vec128<uint> Flip(this in Vec128<uint> lhs)
            => flip(in lhs);
