...
namespace Z0
{
    ...
    /// </summary>
    /// <remarks>
    /// Algorithms derived from https://github.com/lemire/fastmod
    /// </remarks>
    ...
    {        
        ...
        /// <summary>
        /// The equivalent untyped modulus
        /// </summary>
        static readonly Mod _Mod = Mod.Define(_N);
        ...
        static uint Inverse(uint a)
        {
            ...
            for(var i=1; i<_N; i++)
                if(prod[i,a] == 1u) return prod[i,a];                                
