...
namespace Z0
{
    ...
    public class Span256Sampler : Sampler<Span256Sampler>
    {
        ...
        // public Span256<T> Sampled2<T>()
        // {
        //     var prim = PrimalKinds.kind<T>();
        //     switch(prim)
        //     {
        //         case PrimalKind.int8: 
        //             return As.generic<T>(Span256.load(Int8Samples));
        //         case PrimalKind.uint8: 
        //             return As.generic<T>(Span256.load(UInt8Samples));
        //         case PrimalKind.int16: 
        //             return As.generic<T>(Span256.load(Int16Samples));
        //         case PrimalKind.uint16: 
        //             return As.generic<T>(Span256.load(UInt16Samples));
        //         case PrimalKind.int32: 
        //             return As.generic<T>(Span256.load(Int32Samples));
        //         case PrimalKind.uint32: 
        //             return As.generic<T>(Span256.load(UInt32Samples));
        //         case PrimalKind.int64: 
        //             return As.generic<T>(Span256.load(Int64Samples));
        //         case PrimalKind.uint64: 
        //             return As.generic<T>(Span256.load(UInt64Samples));
        //         case PrimalKind.float32: 
        //             return As.generic<T>(Span256.load(Float32Samples));
        //         case PrimalKind.float64: 
        //             return As.generic<T>(Span256.load(Float64Samples));
        //         default:
