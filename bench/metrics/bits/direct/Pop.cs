...
namespace Z0.Metrics
{
    ...
    public class PopDMetrics
    {
        public static Metrics<ulong> Pop<S>(ReadOnlySpan<S> src, BitDConfig config = null)
            where S : struct
        {
        ...
        public Metrics<T> Measure<T>(BitDConfig config, IRandomizer random) where T : struct
        {
        ...
        static Metrics<ulong> Pop(ReadOnlySpan<sbyte> src, BitDConfig config = null)
        {
        ...
        static Metrics<ulong> Pop(ReadOnlySpan<byte> src, BitDConfig config = null)
        {
        ...
        static Metrics<ulong> Pop(ReadOnlySpan<short> src, BitDConfig config = null)
        {
        ...
        static Metrics<ulong> Pop(ReadOnlySpan<ushort> src, BitDConfig config = null)
        {
        ...
        static Metrics<ulong> Pop(ReadOnlySpan<int> src, BitDConfig config = null)
        {
        ...
        static Metrics<ulong> Pop(ReadOnlySpan<uint> src, BitDConfig config = null)
        {
        ...
        static Metrics<ulong> Pop(ReadOnlySpan<long> src, BitDConfig config = null)
        {
        ...
        static Metrics<ulong> Pop(ReadOnlySpan<ulong> src, BitDConfig config = null)
        {
            OpId opid = Id<long>(OpKind.Pop);            
            var dst = span<ulong>(src.Length);
            var cycles = Cycles(config);
