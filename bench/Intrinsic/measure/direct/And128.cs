...
namespace Z0.Measure
{
    ...
    public static class AndInX128D
    {
        ...
        public static Metrics<T> And<T>(this InXMetricConfig128 config, ReadOnlySpan128<T> lhs, ReadOnlySpan128<T> rhs)
            where T : struct
                =>  And(lhs,rhs,config);
        ...
        static Metrics<sbyte> And(ReadOnlySpan128<sbyte> lhs, ReadOnlySpan128<sbyte> rhs, InXMetricConfig128 config)
        {
