...
namespace Z0
{
    ...
    public static class NextIntX
    {
        ...
        [MethodImpl(Inline)]
        public static sbyte NextI8(this IRandomSource rng, sbyte max)
        ...
        /// <param name="max">The exclusive maximum</param>
        [MethodImpl(Inline)]
        public static byte NextU8(this IRandomSource rng, byte max)
        ...
        /// <param name="max">The exclusive maximum</param>
        [MethodImpl(Inline)]
        public static short NextI16(this IRandomSource rng, short max)
            => max >= 0 
        ...
        /// <param name="max">The exclusive maximum</param>
        [MethodImpl(Inline)]
        public static ushort NextU16(this IRandomSource rng, ushort max)
