...
double sqrt(double x)
{
	...
	// Note, frexp and ldexp are used in order to handle denormal numbers properly.
	// approximate square root of number between 0.5 and 1 relative error of approximation = 7.47e-3
