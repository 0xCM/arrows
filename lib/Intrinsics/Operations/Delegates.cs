...
namespace Z0
{
    ...
    public static partial class InXDelegates
    {
        ...
        public static readonly Vector128BinOp<sbyte> AddI8 = Avx2.Add;

        public static readonly Vector128BinOp<byte> AddU8 = Avx2.Add;

        public static readonly Vector128BinOp<short> AddI16 = Avx2.Add;
        
        public static readonly Vector128BinOp<ushort> AddU16 = Avx2.Add;

        public static readonly Vector128BinOp<int> AddI32 = Avx2.Add;
        
        public static readonly Vector128BinOp<uint> AddU32 = Avx2.Add;

        public static readonly Vector128BinOp<long> AddI64 = Avx2.Add;

        public static readonly Vector128BinOp<ulong> AddU64 = Avx2.Add;

        public static readonly Vector128BinOp<float> AddF32 = Avx2.Add;

        public static readonly Vector128BinOp<double> AddF64 = Avx2.Add;


        static readonly PrimalIndex AddDelegates  = PrimKinds.index
            (@sbyte : AddI8, 
             @byte : AddU8, 
             @short : AddI16, 
             @ushort : AddU16, 
        ...
        [MethodImpl(Inline)]
        public static Vector128StoreOp<T> Store<T>()
           where T : struct, IEquatable<T>
                => StoreDelegates.lookup<T,Vector128StoreOp<T>>();
        ...
        public static Vector128BinOp<T> Add<T>()
           where T : struct, IEquatable<T>
                => AddDelegates.lookup<T,Vector128BinOp<T>>();

        [MethodImpl(Inline)]
        public static Vector128LoadOp<T> Load<T>()
           where T : struct, IEquatable<T>
                => LoadDelegates.lookup<T,Vector128LoadOp<T>>();
    }
}