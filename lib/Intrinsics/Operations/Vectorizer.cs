...
namespace Z0
{
    ...
    public static class Vectorizer
    {
        ...
        static unsafe Index<sbyte> Vectorize(in Vec128BinOp<sbyte> Op, in Index<sbyte> lhs, in Index<sbyte> rhs)
        {
            ...
            fixed(sbyte* pDst = &target[0])
            {
                ...
                for(var i = 0; i< count; i += veclen, pLhsWalk += veclen, pRhsWalk += veclen, pDstWalk += veclen)
                {
                    ...
                    InX.store(Op(vLeft,vRight), pDst);                
                }
            }
            return target;            
        }

        static unsafe Index<byte> Vectorize(in Vec128BinOp<byte> Op, in Index<byte> lhs, in Index<byte> rhs)
        {
            var count = matchedCount(lhs,rhs);
        ...
        static unsafe Index<short> Vectorize(in Vec128BinOp<short> Op, in Index<short> lhs, in Index<short> rhs)
        {
            var count = matchedCount(lhs,rhs);
        ...
        static unsafe Index<ushort> Vectorize(in Vec128BinOp<ushort> Op, in Index<ushort> lhs, in Index<ushort> rhs)
        {
            var count = matchedCount(lhs,rhs);
        ...
        static unsafe Index<int> Vectorize(in Vec128BinOp<int> Op, in Index<int> lhs, in Index<int> rhs)
        {
            var count = matchedCount(lhs,rhs);
        ...
        static unsafe Index<uint> Vectorize(in Vec128BinOp<uint> Op, in Index<uint> lhs, in Index<uint> rhs)
        {
            var count = matchedCount(lhs,rhs);
        ...
        static unsafe Index<long> Vectorize(in Vec128BinOp<long> Op, in Index<long> lhs, in Index<long> rhs)
        {
            var count = matchedCount(lhs,rhs);
        ...
        static unsafe Index<ulong> Vectorize(in Vec128BinOp<ulong> Op, in Index<ulong> lhs, in Index<ulong> rhs)
        {
            var count = matchedCount(lhs,rhs);
        ...
        static unsafe Index<float> Vectorize(in Vec128BinOp<float> Op, in Index<float> lhs, in Index<float> rhs)
        {
            var count = matchedCount(lhs,rhs);
        ...
        static unsafe Index<double> Vectorize(in Vec128BinOp<double> Op, in Index<double> lhs, in Index<double> rhs)
        {
            var count = matchedCount(lhs,rhs);
