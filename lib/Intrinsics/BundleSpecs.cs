...
namespace Z0
{
    ...
    public interface InXAddScalar<T> : InXOp<T>
        where T : struct, IEquatable<T>
        {
            Num128<T> add(in Num128<T> lhs, in Num128<T> rhs);
        ...
        where T : struct, IEquatable<T>
    {
        ...
        void add(in Vec128<T> lhs, in Vec128<T> rhs, out Vec128<T> dst);
        
        void add(in Vec128<T> lhs, in Vec128<T> rhs,  T[] dst, int offset = 0);
    }
        ...
        where T : struct, IEquatable<T>
    {
        ...
        void and(in Vec128<T> lhs, in Vec128<T> rhs, out Vec128<T> dst);                

        void and(in Vec128<T> lhs, in Vec128<T> rhs,  T[] dst, int offset = 0);
