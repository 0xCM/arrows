...
namespace Z0
{
    ...
    {
        /// <summary>
        /// Classifies a unary identity operation id such that id(x) = x for x:T
        /// </summary>
        Id = 0,

        /// <summary>
        /// Classifies a binary predicate eq such that eq(x,y)  == true iff x == y
        /// </summary>
        Eq,

        /// <summary>
        /// Classifies a binary predicate neq such that neq(x,y) == true iff x != y
        /// </summary>
        NEq,

        /// <summary>
        /// Classifies a binary predicate gt such that gt(x,y) == true iff x > y
        /// </summary>
        Gt,

        /// <summary>
        /// Classifies a binary predicate ngt such that ngt(x,y) == true iff x <= y
        /// </summary>
        NGt,
