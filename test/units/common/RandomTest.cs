...
namespace Z0.Test
{
    ...
    public class RandomTest : UnitTest<RandomTest>
    {
        ...
        public void I8DomainSatisifed()
        {
            ...
            var domain = closed((sbyte)(-100),(sbyte)(100)).AsCanonical();
        ...
        {
            var samples = Pow2.T11;
            var domain = closed(1u,1000u).AsCanonical();
        ...
        {
            var samples = Pow2.T11;
            var domain = closed(1ul,1000ul).AsCanonical();
        ...
        {
            var samples = Pow2.T11;
            var domain = closed(-250L,250L).AsCanonical();
