...
namespace Z0
{
	...
	public struct ComplexI8 : IEquatable<ComplexI8>
	{
		/// <summary>
		...
		[MethodImpl(Inline)]
		public static Span<ComplexI8> Load(Span<sbyte> src)
		{
			if(src.Length % 2 != 0)
				throw new Exception("Missing component");
			return MemoryMarshal.Cast<sbyte,ComplexI8>(src);
		}
		...
		[MethodImpl(Inline)]
        public static ComplexI8 operator -(in ComplexI8 lhs, in ComplexI8 rhs)
            => ((sbyte)(lhs.re - rhs.re), (sbyte)(lhs.im - rhs.im));
        ...
        /// <param name="rhs">The second operand</param>
		[MethodImpl(Inline)]
        public static bool operator ==(in ComplexI8 lhs, in ComplexI8 rhs)
		...
		[MethodImpl(Inline)]
		public static implicit operator ComplexI8((sbyte re, sbyte im) x)
			=> new ComplexI8(x);
		...
		/// <param name="im">The imaginary component</param>
		[MethodImpl(Inline)]
		public static implicit operator (sbyte re, sbyte im)(ComplexI8 x)
			=> (x.re, x.im);
		...
		/// <param name="im">The imaginary component</param>
		[MethodImpl(Inline)]
        public ComplexI8((sbyte re, sbyte im) x)
		{
			this.re = x.re;
			this.im = x.im;
		}
		...
		/// <param name="im">The imaginary component</param>
		[MethodImpl(Inline)]
        public ComplexI8(sbyte re, sbyte im)
		{
			this.re = re;
			this.im = im;
		}
		...
		/// <param name="im">The imaginary component</param>
		[MethodImpl(Inline)]
		public void Deconstruct(out sbyte re, out sbyte im)
		{
			re = this.re;
			im = this.im;
		}		
