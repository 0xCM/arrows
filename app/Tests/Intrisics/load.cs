...
//         {
//             var src0 = Arr.SubArray(UnarySrc.ToArray(), offset, VecLength);
//             var src1 = UnarySrc.ToArray()[offset..offset + VecLength];
//             var v1 = Vec128.single<T>(src0);
//             var v2 = Vec128.single<T>(src1);
//             Claim.eq(v1,v2);
