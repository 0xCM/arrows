...
namespace Z0.Tests.InXTests
{
    ...
    public class CmpFTests
    {
        ...
        public class CmpF64 : CmpFTest<CmpF64, double>
        {
            ...
            public void BitPack()
            {
                Claim.eq((byte)0b01110011,Z0.Bits.bitpack(1,1,0,0,1,1,1,0));

                Claim.eq((byte)0b00000001,Z0.Bits.bitpack(1,0,0,0,0,0,0,0));

                Claim.eq((byte)0b00000010,Z0.Bits.bitpack(0,1,0,0,0,0,0,0));

                Claim.eq((byte)0b11111111,Z0.Bits.bitpack(1,1,1,1,1,1,1,1));
