...
namespace Core.Contracts
{
    ...
    /// <summary>
    /// Characterizes a term in a sequence
    /// </summary>
    /// <typeparam name="I">The integral index type</typeparam>
    /// <typeparam name="T">The term type</typeparam>
    public interface IndexedTerm<I,T>
        where I : Integer<I>,new()
    {
        ...
        /// <summary>
        /// The term determined by the index
        /// </summary>
        T term {get;}
    }
        ...
        where I : Integer<I>,new()
    {
        ...
        /// </summary>
        /// <returns></returns>
        IEnumerable<IndexedTerm<I,T>> terms();
    }
