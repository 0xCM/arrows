...
namespace Z0.Mkl.Test
{
    ...
    public class SSExtremaTest: UnitTest<SSExtremaTest>
    {
        ...
        public void VerifyMin()
        {
            ...
            var s1 = Random.Span<double>(samplesize, s1Range);
        ...
        {
            Span<double> src = new double[]{4,8,10};
        ...
        {
            var src = Random.Span<double>(Pow2.T14);
        ...
        void TimeMean()
        {
            ...
            var src = Random.Span<long>(samples, closed(-2000L, 2000L));
            var last = 0L;
