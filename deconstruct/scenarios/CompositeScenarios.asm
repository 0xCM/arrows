; 2019-07-31 03:55:30:221
; function: byte rotr8u(byte src, byte offset)
; location: [7FFC7CC047D0h, 7FFC7CC047F2h]
...
; location: [7FFC7CC04810h, 7FFC7CC04832h]
0000h nop dword ptr [rax+rax]       ; NOP(Nop_rm32) [mem(32u,RAX:br,DS:sr)]                encoding(5 bytes) = 0f 1f 44 00 00
...
; location: [7FFC7CC04850h, 7FFC7CC0485Bh]
0000h nop dword ptr [rax+rax]       ; NOP(Nop_rm32) [mem(32u,RAX:br,DS:sr)]                encoding(5 bytes) = 0f 1f 44 00 00
...
; location: [7FFC7CC04870h, 7FFC7CC0487Dh]
0000h nop dword ptr [rax+rax]       ; NOP(Nop_rm32) [mem(32u,RAX:br,DS:sr)]                encoding(5 bytes) = 0f 1f 44 00 00
...
; location: [7FFC7CC04890h, 7FFC7CC048B2h]
0000h nop dword ptr [rax+rax]       ; NOP(Nop_rm32) [mem(32u,RAX:br,DS:sr)]                encoding(5 bytes) = 0f 1f 44 00 00
0005h movzx eax,cl                  ; MOVZX(Movzx_r32_rm8) [EAX,CL]                        encoding(3 bytes) = 0f b6 c1
0008h movzx edx,dl                  ; MOVZX(Movzx_r32_rm8) [EDX,DL]                        encoding(3 bytes) = 0f b6 d2
000bh mov ecx,edx                   ; MOV(Mov_r32_rm32) [ECX,EDX]                          encoding(2 bytes) = 8b ca
...
; location: [7FFC7CC048D0h, 7FFC7CC048F2h]
0000h nop dword ptr [rax+rax]       ; NOP(Nop_rm32) [mem(32u,RAX:br,DS:sr)]                encoding(5 bytes) = 0f 1f 44 00 00
0005h movzx eax,cx                  ; MOVZX(Movzx_r32_rm16) [EAX,CX]                       encoding(3 bytes) = 0f b7 c1
0008h movzx edx,dx                  ; MOVZX(Movzx_r32_rm16) [EDX,DX]                       encoding(3 bytes) = 0f b7 d2
000bh mov ecx,edx                   ; MOV(Mov_r32_rm32) [ECX,EDX]                          encoding(2 bytes) = 8b ca
...
; location: [7FFC7CC04910h, 7FFC7CC0491Bh]
0000h nop dword ptr [rax+rax]       ; NOP(Nop_rm32) [mem(32u,RAX:br,DS:sr)]                encoding(5 bytes) = 0f 1f 44 00 00
0005h mov eax,ecx                   ; MOV(Mov_r32_rm32) [EAX,ECX]                          encoding(2 bytes) = 8b c1
0007h mov ecx,edx                   ; MOV(Mov_r32_rm32) [ECX,EDX]                          encoding(2 bytes) = 8b ca
...
; location: [7FFC7CC04930h, 7FFC7CC0493Dh]
0000h nop dword ptr [rax+rax]       ; NOP(Nop_rm32) [mem(32u,RAX:br,DS:sr)]                encoding(5 bytes) = 0f 1f 44 00 00
0005h mov rax,rcx                   ; MOV(Mov_r64_rm64) [RAX,RCX]                          encoding(3 bytes) = 48 8b c1
0008h mov ecx,edx                   ; MOV(Mov_r32_rm32) [ECX,EDX]                          encoding(2 bytes) = 8b ca
...
; location: [7FFC7CC04950h, 7FFC7CC0497Bh]
...
; location: [7FFC7CC049A0h, 7FFC7CC049B1h]
0000h nop dword ptr [rax+rax]       ; NOP(Nop_rm32) [mem(32u,RAX:br,DS:sr)]                encoding(5 bytes) = 0f 1f 44 00 00
...
; location: [7FFC7CC049D0h, 7FFC7CC049DFh]
0000h nop dword ptr [rax+rax]       ; NOP(Nop_rm32) [mem(32u,RAX:br,DS:sr)]                encoding(5 bytes) = 0f 1f 44 00 00
...
----------------------------------------------------------------------------------------------------------------------------------------------------------------
; function: int space3()
; location: [7FFC7CC049F0h, 7FFC7CC04A23h]
...
0014h call 7FFCDC14C680h            ; CALL(Call_rel32_64) [5F547C90h:jmp64]                encoding(5 bytes) = e8 77 7c 54 5f
0019h mov eax,[7FFC7C6D6BDCh]       ; MOV(Mov_r32_rm32) [EAX,mem(32u,RIP:br,DS:sr)]        encoding(6 bytes) = 8b 05 cd 21 ad ff
001fh mov edx,[7FFC7C6D6BE0h]       ; MOV(Mov_r32_rm32) [EDX,mem(32u,RIP:br,DS:sr)]        encoding(6 bytes) = 8b 15 cb 21 ad ff
0025h mov ecx,[7FFC7C6D6BE4h]       ; MOV(Mov_r32_rm32) [ECX,mem(32u,RIP:br,DS:sr)]        encoding(6 bytes) = 8b 0d c9 21 ad ff
...
; static ReadOnlySpan<byte> space3Bytes => new byte[52]{0x48,0x83,0xEC,0x28,0x90,0x48,0xB9,0x80,0x6B,0x6D,0x7C,0xFC,0x7F,0x00,0x00,0xBA,0x05,0x00,0x00,0x00,0xE8,0x77,0x7C,0x54,0x5F,0x8B,0x05,0xCD,0x21,0xAD,0xFF,0x8B,0x15,0xCB,0x21,0xAD,0xFF,0x8B,0x0D,0xC9,0x21,0xAD,0xFF,0x03,0xC2,0x03,0xC1,0x48,0x83,0xC4,0x28,0xC3};
----------------------------------------------------------------------------------------------------------------------------------------------------------------
