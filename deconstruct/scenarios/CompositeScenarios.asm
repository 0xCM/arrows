; 2019-08-27 17:10:31:495
; function: byte rotr8u(byte src, byte offset)
; location: [7FFC7BEBBBF0h, 7FFC7BEBBC00h]
...
; location: [7FFC7BEBBC20h, 7FFC7BEBBC30h]
0000h nop dword ptr [rax+rax]       ; NOP(Nop_rm32) [mem(32u,RAX:br,DS:sr)]                encoding(5 bytes) = 0f 1f 44 00 00
...
; location: [7FFC7BEBBC50h, 7FFC7BEBBC5Bh]
0000h nop dword ptr [rax+rax]       ; NOP(Nop_rm32) [mem(32u,RAX:br,DS:sr)]                encoding(5 bytes) = 0f 1f 44 00 00
...
; location: [7FFC7BEBBC70h, 7FFC7BEBBC7Dh]
0000h nop dword ptr [rax+rax]       ; NOP(Nop_rm32) [mem(32u,RAX:br,DS:sr)]                encoding(5 bytes) = 0f 1f 44 00 00
...
; location: [7FFC7BEBBC90h, 7FFC7BEBBCA0h]
0000h nop dword ptr [rax+rax]       ; NOP(Nop_rm32) [mem(32u,RAX:br,DS:sr)]                encoding(5 bytes) = 0f 1f 44 00 00
0005h movzx eax,cl                  ; MOVZX(Movzx_r32_rm8) [EAX,CL]                        encoding(3 bytes) = 0f b6 c1
0008h movzx ecx,dl                  ; MOVZX(Movzx_r32_rm8) [ECX,DL]                        encoding(3 bytes) = 0f b6 ca
...
; location: [7FFC7BEBBCC0h, 7FFC7BEBBCD0h]
0000h nop dword ptr [rax+rax]       ; NOP(Nop_rm32) [mem(32u,RAX:br,DS:sr)]                encoding(5 bytes) = 0f 1f 44 00 00
0005h movzx eax,cx                  ; MOVZX(Movzx_r32_rm16) [EAX,CX]                       encoding(3 bytes) = 0f b7 c1
0008h movzx ecx,dx                  ; MOVZX(Movzx_r32_rm16) [ECX,DX]                       encoding(3 bytes) = 0f b7 ca
000bh rol eax,cl                    ; ROL(Rol_rm32_CL) [EAX,CL]                            encoding(2 bytes) = d3 c0
...
; location: [7FFC7BEBBCF0h, 7FFC7BEBBCFBh]
0000h nop dword ptr [rax+rax]       ; NOP(Nop_rm32) [mem(32u,RAX:br,DS:sr)]                encoding(5 bytes) = 0f 1f 44 00 00
0005h mov eax,ecx                   ; MOV(Mov_r32_rm32) [EAX,ECX]                          encoding(2 bytes) = 8b c1
0007h mov ecx,edx                   ; MOV(Mov_r32_rm32) [ECX,EDX]                          encoding(2 bytes) = 8b ca
...
; location: [7FFC7BEBBD10h, 7FFC7BEBBD1Dh]
0000h nop dword ptr [rax+rax]       ; NOP(Nop_rm32) [mem(32u,RAX:br,DS:sr)]                encoding(5 bytes) = 0f 1f 44 00 00
0005h mov rax,rcx                   ; MOV(Mov_r64_rm64) [RAX,RCX]                          encoding(3 bytes) = 48 8b c1
0008h mov ecx,edx                   ; MOV(Mov_r32_rm32) [ECX,EDX]                          encoding(2 bytes) = 8b ca
...
; location: [7FFC7BEBBD30h, 7FFC7BEBBD5Bh]
...
; location: [7FFC7BEBBD80h, 7FFC7BEBBD91h]
0000h nop dword ptr [rax+rax]       ; NOP(Nop_rm32) [mem(32u,RAX:br,DS:sr)]                encoding(5 bytes) = 0f 1f 44 00 00
...
; location: [7FFC7BEBBDB0h, 7FFC7BEBBDBFh]
0000h nop dword ptr [rax+rax]       ; NOP(Nop_rm32) [mem(32u,RAX:br,DS:sr)]                encoding(5 bytes) = 0f 1f 44 00 00
...
----------------------------------------------------------------------------------------------------------------------------------------------------------------
; function: int space3()
; location: [7FFC7BEBBDD0h, 7FFC7BEBBE03h]
0000h sub rsp,28h                   ; SUB(Sub_rm64_imm8) [RSP,28h:imm64]                   encoding(4 bytes) = 48 83 ec 28
0004h nop                           ; NOP(Nopd)                                            encoding(1 byte ) = 90
0005h mov rcx,7FFC7B966B80h         ; MOV(Mov_r64_imm64) [RCX,7ffc7b966b80h:imm64]         encoding(10 bytes) = 48 b9 80 6b 96 7b fc 7f 00 00
000fh mov edx,5                     ; MOV(Mov_r32_imm32) [EDX,5h:imm32]                    encoding(5 bytes) = ba 05 00 00 00
0014h call 7FFCDB3BC680h            ; CALL(Call_rel32_64) [5F5008B0h:jmp64]                encoding(5 bytes) = e8 97 08 50 5f
0019h mov eax,[7FFC7B966BDCh]       ; MOV(Mov_r32_rm32) [EAX,mem(32u,RIP:br,DS:sr)]        encoding(6 bytes) = 8b 05 ed ad aa ff
001fh mov edx,[7FFC7B966BE0h]       ; MOV(Mov_r32_rm32) [EDX,mem(32u,RIP:br,DS:sr)]        encoding(6 bytes) = 8b 15 eb ad aa ff
0025h mov ecx,[7FFC7B966BE4h]       ; MOV(Mov_r32_rm32) [ECX,mem(32u,RIP:br,DS:sr)]        encoding(6 bytes) = 8b 0d e9 ad aa ff
...
; static ReadOnlySpan<byte> space3Bytes => new byte[52]{0x48,0x83,0xEC,0x28,0x90,0x48,0xB9,0x80,0x6B,0x96,0x7B,0xFC,0x7F,0x00,0x00,0xBA,0x05,0x00,0x00,0x00,0xE8,0x97,0x08,0x50,0x5F,0x8B,0x05,0xED,0xAD,0xAA,0xFF,0x8B,0x15,0xEB,0xAD,0xAA,0xFF,0x8B,0x0D,0xE9,0xAD,0xAA,0xFF,0x03,0xC2,0x03,0xC1,0x48,0x83,0xC4,0x28,0xC3};
----------------------------------------------------------------------------------------------------------------------------------------------------------------
