; 2019-07-30 13:37:35:682
; function: byte rotr8u(byte src, byte offset)
; location: [7FFC7CBF41D0h, 7FFC7CBF41F2h]
...
; location: [7FFC7CBF4210h, 7FFC7CBF4232h]
0000h nop dword ptr [rax+rax]       ; NOP(Nop_rm32) [mem(32u,RAX:br,DS:sr)]                encoding(5 bytes) = 0f 1f 44 00 00
...
; location: [7FFC7CBF4250h, 7FFC7CBF425Bh]
0000h nop dword ptr [rax+rax]       ; NOP(Nop_rm32) [mem(32u,RAX:br,DS:sr)]                encoding(5 bytes) = 0f 1f 44 00 00
...
; location: [7FFC7CBF4270h, 7FFC7CBF427Dh]
0000h nop dword ptr [rax+rax]       ; NOP(Nop_rm32) [mem(32u,RAX:br,DS:sr)]                encoding(5 bytes) = 0f 1f 44 00 00
...
; location: [7FFC7CBF4290h, 7FFC7CBF42B2h]
0000h nop dword ptr [rax+rax]       ; NOP(Nop_rm32) [mem(32u,RAX:br,DS:sr)]                encoding(5 bytes) = 0f 1f 44 00 00
0005h movzx eax,cl                  ; MOVZX(Movzx_r32_rm8) [EAX,CL]                        encoding(3 bytes) = 0f b6 c1
0008h movzx edx,dl                  ; MOVZX(Movzx_r32_rm8) [EDX,DL]                        encoding(3 bytes) = 0f b6 d2
000bh mov ecx,edx                   ; MOV(Mov_r32_rm32) [ECX,EDX]                          encoding(2 bytes) = 8b ca
...
; location: [7FFC7CBF42D0h, 7FFC7CBF42F2h]
0000h nop dword ptr [rax+rax]       ; NOP(Nop_rm32) [mem(32u,RAX:br,DS:sr)]                encoding(5 bytes) = 0f 1f 44 00 00
0005h movzx eax,cx                  ; MOVZX(Movzx_r32_rm16) [EAX,CX]                       encoding(3 bytes) = 0f b7 c1
0008h movzx edx,dx                  ; MOVZX(Movzx_r32_rm16) [EDX,DX]                       encoding(3 bytes) = 0f b7 d2
000bh mov ecx,edx                   ; MOV(Mov_r32_rm32) [ECX,EDX]                          encoding(2 bytes) = 8b ca
...
; location: [7FFC7CBF4310h, 7FFC7CBF431Bh]
0000h nop dword ptr [rax+rax]       ; NOP(Nop_rm32) [mem(32u,RAX:br,DS:sr)]                encoding(5 bytes) = 0f 1f 44 00 00
0005h mov eax,ecx                   ; MOV(Mov_r32_rm32) [EAX,ECX]                          encoding(2 bytes) = 8b c1
0007h mov ecx,edx                   ; MOV(Mov_r32_rm32) [ECX,EDX]                          encoding(2 bytes) = 8b ca
...
; location: [7FFC7CBF4330h, 7FFC7CBF433Dh]
0000h nop dword ptr [rax+rax]       ; NOP(Nop_rm32) [mem(32u,RAX:br,DS:sr)]                encoding(5 bytes) = 0f 1f 44 00 00
0005h mov rax,rcx                   ; MOV(Mov_r64_rm64) [RAX,RCX]                          encoding(3 bytes) = 48 8b c1
0008h mov ecx,edx                   ; MOV(Mov_r32_rm32) [ECX,EDX]                          encoding(2 bytes) = 8b ca
...
; location: [7FFC7CBF4350h, 7FFC7CBF437Bh]
...
; location: [7FFC7CBF43A0h, 7FFC7CBF43B1h]
0000h nop dword ptr [rax+rax]       ; NOP(Nop_rm32) [mem(32u,RAX:br,DS:sr)]                encoding(5 bytes) = 0f 1f 44 00 00
...
; location: [7FFC7CBF43D0h, 7FFC7CBF43DFh]
0000h nop dword ptr [rax+rax]       ; NOP(Nop_rm32) [mem(32u,RAX:br,DS:sr)]                encoding(5 bytes) = 0f 1f 44 00 00
...
----------------------------------------------------------------------------------------------------------------------------------------------------------------
; function: int space3()
; location: [7FFC7CBF43F0h, 7FFC7CBF4435h]
0000h sub rsp,28h                   ; SUB(Sub_rm64_imm8) [RSP,28h:imm64]                   encoding(4 bytes) = 48 83 ec 28
0004h nop                           ; NOP(Nopd)                                            encoding(1 byte ) = 90
0005h mov rcx,7FFC7C6C6B80h         ; MOV(Mov_r64_imm64) [RCX,7ffc7c6c6b80h:imm64]         encoding(10 bytes) = 48 b9 80 6b 6c 7c fc 7f 00 00
000fh mov edx,5                     ; MOV(Mov_r32_imm32) [EDX,5h:imm32]                    encoding(5 bytes) = ba 05 00 00 00
0014h call 7FFCDC14C680h            ; CALL(Call_rel32_64) [5F558290h:jmp64]                encoding(5 bytes) = e8 77 82 55 5f
0019h mov rax,7FFC7C6C6BDCh         ; MOV(Mov_r64_imm64) [RAX,7ffc7c6c6bdch:imm64]         encoding(10 bytes) = 48 b8 dc 6b 6c 7c fc 7f 00 00
0023h mov eax,[rax]                 ; MOV(Mov_r32_rm32) [EAX,mem(32u,RAX:br,DS:sr)]        encoding(2 bytes) = 8b 00
0025h mov rdx,7FFC7C6C6BE0h         ; MOV(Mov_r64_imm64) [RDX,7ffc7c6c6be0h:imm64]         encoding(10 bytes) = 48 ba e0 6b 6c 7c fc 7f 00 00
002fh mov edx,[rdx]                 ; MOV(Mov_r32_rm32) [EDX,mem(32u,RDX:br,DS:sr)]        encoding(2 bytes) = 8b 12
0031h mov rcx,7FFC7C6C6BE4h         ; MOV(Mov_r64_imm64) [RCX,7ffc7c6c6be4h:imm64]         encoding(10 bytes) = 48 b9 e4 6b 6c 7c fc 7f 00 00
...
; static ReadOnlySpan<byte> space3Bytes = new byte[70]{0x48,0x83,0xEC,0x28,0x90,0x48,0xB9,0x80,0x6B,0x6C,0x7C,0xFC,0x7F,0x00,0x00,0xBA,0x05,0x00,0x00,0x00,0xE8,0x77,0x82,0x55,0x5F,0x48,0xB8,0xDC,0x6B,0x6C,0x7C,0xFC,0x7F,0x00,0x00,0x8B,0x00,0x48,0xBA,0xE0,0x6B,0x6C,0x7C,0xFC,0x7F,0x00,0x00,0x8B,0x12,0x48,0xB9,0xE4,0x6B,0x6C,0x7C,0xFC,0x7F,0x00,0x00,0x8B,0x09,0x03,0xC2,0x03,0xC1,0x48,0x83,0xC4,0x28,0xC3};
----------------------------------------------------------------------------------------------------------------------------------------------------------------
