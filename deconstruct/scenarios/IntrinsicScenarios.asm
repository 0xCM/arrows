; 2019-09-21 04:40:21:074
; function: byte project1(byte src, uint part)
; location: [7FFC7F18C5E0h, 7FFC7F18C5F9h]
...
; location: [7FFC7F18C610h, 7FFC7F18C61Dh]
0000h nop dword ptr [rax+rax]       ; NOP(Nop_rm32) [mem(32u,RAX:br,DS:sr)]                encoding(5 bytes) = 0f 1f 44 00 00
...
; location: [7FFC7F18C650h, 7FFC7F18C65Ah]
0000h nop dword ptr [rax+rax]       ; NOP(Nop_rm32) [mem(32u,RAX:br,DS:sr)]                encoding(5 bytes) = 0f 1f 44 00 00
0005h pdep eax,ecx,edx              ; PDEP(VEX_Pdep_r32_r32_rm32) [EAX,ECX,EDX]            encoding(VEX, 5 bytes) = c4 e2 73 f5 c2
...
; location: [7FFC7F18C690h, 7FFC7F18C69Dh]
0000h nop dword ptr [rax+rax]       ; NOP(Nop_rm32) [mem(32u,RAX:br,DS:sr)]                encoding(5 bytes) = 0f 1f 44 00 00
0005h pdep eax,ecx,edx              ; PDEP(VEX_Pdep_r32_r32_rm32) [EAX,ECX,EDX]            encoding(VEX, 5 bytes) = c4 e2 73 f5 c2
000ah movzx eax,al                  ; MOVZX(Movzx_r32_rm8) [EAX,AL]                        encoding(3 bytes) = 0f b6 c0
000dh ret                           ; RET(Retnq)                                           encoding(1 byte ) = c3
...
; location: [7FFC7F18EA10h, 7FFC7F18EA42h]
...
; location: [7FFC7F18EA60h, 7FFC7F18EAD5h]
...
0058h call 7FFC7F17AA00h            ; CALL(Call_rel32_64) [FFFFFFFFFFFEBFA0h:jmp64]        encoding(5 bytes) = e8 43 bf fe ff
