namespace Z0
{
    ...
    public static partial class PCG
    {
        ...
        [MethodImpl(Inline)]
        public static void pcg_oneseq_16_step_r(pcg_state_16 rng)
            => rng.state = (ushort)(rng.state * PCG_DEFAULT_MULTIPLIER_16 + PCG_DEFAULT_INCREMENT_16);

        [MethodImpl(Inline)]
        public static void pcg_setseq_16_step_r(pcg_state_setseq_16 rng)
            => rng.state = (ushort)(rng.state * PCG_DEFAULT_MULTIPLIER_16 + rng.inc);
        ...
        [MethodImpl(Inline)]
        public static void pcg_unique_16_step_r(pcg_state_16 rng)
            => rng.state = (ushort)(rng.state * PCG_DEFAULT_MULTIPLIER_16 + (rng.oid | 1u));
        ...
        public static void pcg_unique_32_step_r(pcg_state_32 rng)
            => rng.state = rng.state * PCG_DEFAULT_MULTIPLIER_32 + (rng.oid | 1u);
    }
