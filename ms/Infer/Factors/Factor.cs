...
{    
    ...
    public static class Factor
    {
        ...
        {
            return MsInfer.Distributions.Bernoulli.Sample(probTrue);
        }
        ...
        {
            return MsInfer.Distributions.Discrete.Sample(probs.RowVector(selector));
        }
        ...
        {
            return MsInfer.Distributions.Discrete.Sample(probs);
        }
