...
namespace Z0.Mkl
{
	...
	partial class CBLAS
	{
		...
		[DllImport(CBlasDll, CallingConvention=Cdecl, ExactSpelling=true)]
		public static extern void cblas_cgemm(CBLAS_LAYOUT Layout, CBLAS_TRANSPOSE TransA, CBLAS_TRANSPOSE TransB, int M, int N, int K,
			ref ComplexF32 alpha, ref ComplexF32 A, int lda, ref ComplexF32 B, int ldb,ref ComplexF32 beta, ref ComplexF32 C, int ldc);

	
		[DllImport(CBlasDll, CallingConvention=Cdecl, ExactSpelling=true)]
		public static extern void cblas_sgemm(CBLAS_LAYOUT Layout, CBLAS_TRANSPOSE TransA, CBLAS_TRANSPOSE TransB, int M, int n,
