...
XED_NOINLINE xed_uint64_t xed_dec_lu_OSZ_NONTERM_IMMUNE66_EOSZ_MOD3_OSZ_REP(const xed_decoded_inst_t* d);
...
XED_NOINLINE xed_uint64_t xed_dec_lu_OSZ_NONTERM_EOSZ_MOD3_MODE_VEXDEST210_7_VEXDEST3_VEX_PREFIX_VL(const xed_decoded_inst_t* d);
