    ...
    public static partial class CBLAS
    {
        ...
        */
        ...
        public static extern void cblas_strmv(MatrixLayout Layout, CBLAS_UPLO Uplo,
                        MatrixTranspose TransA, CBLAS_DIAG Diag,
        ...
        */
        [DllImport(CBlasDll, CallingConvention=Cdecl, ExactSpelling=true)]
        public static extern void cblas_sgemm_batch(MatrixLayout Layout, ref MatrixTranspose TransA_Array,
                            ref MatrixTranspose TransB_Array, ref int M_Array, ref int N_Array,
        ...
        [DllImport(CBlasDll, CallingConvention=Cdecl, ExactSpelling=true)]
        public static extern void cblas_dgemm_batch(MatrixLayout Layout, ref MatrixTranspose TransA_Array,
                            ref MatrixTranspose TransB_Array, ref int M_Array, ref int N_Array,
        ...
        [DllImport(CBlasDll, CallingConvention=Cdecl, ExactSpelling=true)]
        public static extern void cblas_sgemmt(MatrixLayout Layout, CBLAS_UPLO Uplo, MatrixTranspose TransA, MatrixTranspose TransB,
                        int n, int K,
        ...
        public static extern void cblas_ssyrk(MatrixLayout Layout, CBLAS_UPLO Uplo,
                        MatrixTranspose Trans, int n, int K,
                        float alpha, ref float A, int lda,
        ...
        public static extern void cblas_strmm(MatrixLayout Layout, CBLAS_SIDE Side,
                        CBLAS_UPLO Uplo, MatrixTranspose TransA,
        ...
        public static extern void cblas_strsm_batch(MatrixLayout Layout, ref CBLAS_SIDE Side_Array,
                            ref CBLAS_UPLO Uplo_Array, ref MatrixTranspose TransA_Array,
        ...
        [DllImport(CBlasDll, CallingConvention=Cdecl, ExactSpelling=true)]
        public static extern void cblas_cgemm3m(MatrixLayout Layout, MatrixTranspose TransA,
                        MatrixTranspose TransB, int M, int n,
                        int K, ref byte alpha, ref byte A,
                        int lda, ref byte B, int ldb,
                        ref byte beta, ref byte C, int ldc);

		[DllImport(CBlasDll, CallingConvention=Cdecl, ExactSpelling=true)]
        public static extern void cblas_cgemm_batch(MatrixLayout Layout, ref MatrixTranspose TransA_Array,
                            ref MatrixTranspose TransB_Array, ref int M_Array, ref int N_Array,
		...
		[DllImport(CBlasDll, CallingConvention=Cdecl, ExactSpelling=true)]
        public static extern void cblas_cgemm3m_batch(MatrixLayout Layout, ref MatrixTranspose TransA_Array,
                                ref MatrixTranspose TransB_Array, ref int M_Array, ref int N_Array,
                                ref int K_Array, ref byte alpha_Array, ref byte A_Array,
                                ref int lda_Array, ref byte B_Array, ref int ldb_Array,
                                ref byte beta_Array, ref byte C_Array, ref int ldc_Array,
		...
		[DllImport(CBlasDll, CallingConvention=Cdecl, ExactSpelling=true)]
        public static extern void cblas_zgemm(MatrixLayout Layout, MatrixTranspose TransA,
                        MatrixTranspose TransB, int M, int n,
                        int K, ref byte alpha, ref byte A,
                        int lda, ref byte B, int ldb,
                        ref byte beta, ref byte C, int ldc);
		...
		[DllImport(CBlasDll, CallingConvention=Cdecl, ExactSpelling=true)]
        public static extern void cblas_zgemm3m(MatrixLayout Layout, MatrixTranspose TransA,
                        MatrixTranspose TransB, int M, int n,
                        int K, ref byte alpha, ref byte A,
                        int lda, ref byte B, int ldb,
                        ref byte beta, ref byte C, int ldc);
		...
		[DllImport(CBlasDll, CallingConvention=Cdecl, ExactSpelling=true)]
        public static extern void cblas_zgemm_batch(MatrixLayout Layout, ref MatrixTranspose TransA_Array,
                            ref MatrixTranspose TransB_Array, ref int M_Array, ref int N_Array,
                            ref int K_Array, ref byte alpha_Array, ref byte A_Array,
                            ref int lda_Array, ref byte B_Array, ref int ldb_Array,
                            ref byte beta_Array, ref byte C_Array, ref int ldc_Array,
		...
		[DllImport(CBlasDll, CallingConvention=Cdecl, ExactSpelling=true)]
        public static extern void cblas_zgemm3m_batch(MatrixLayout Layout, ref MatrixTranspose TransA_Array,
                                ref MatrixTranspose TransB_Array, ref int M_Array, ref int N_Array,
                                ref int K_Array, ref byte alpha_Array, ref byte A_Array,
                                ref int lda_Array, ref byte B_Array, ref int ldb_Array,
                                ref byte beta_Array, ref byte C_Array, ref int ldc_Array,
        ...
        */
        ...
        public static extern void cblas_sgemm_pack(MatrixLayout Layout, CBLAS_IDENTIFIER identifier,
                        MatrixTranspose Trans, int M, int n,
